...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "KMH114_AEC_7h7v_full_2");
		m->declare("license", "BSD 3-Clause License");
		m->declare("name", "KMH114_AEC_7h7v_full_2");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst143 = ((((23984.704660435331 / fConst2) + 296.72293410634251) / fConst2) + 1.0);
		fConst144 = (0.0 - (95938.818641741324 / (fConst3 * fConst143)));
		fConst145 = (0.0 - (((95938.818641741324 / fConst2) + 593.44586821268501) / (fConst2 * fConst143)));
		fConst146 = ((((30145.246817946248 / fConst2) + 215.53769676316182) / fConst2) + 1.0);
		fConst147 = (1.0 / (fConst143 * fConst146));
		fConst148 = (0.0 - (120580.98727178499 / (fConst3 * fConst146)));
		fConst149 = (0.0 - (((120580.98727178499 / fConst2) + 431.07539352632364) / (fConst2 * fConst146)));
		fConst150 = ((118.95641347566826 / fConst2) + 1.0);
		fConst151 = (0.0 - (237.91282695133651 / (fConst2 * fConst150)));
		fConst152 = ((((16950.258950005893 / fConst2) + 188.39996504603437) / fConst2) + 1.0);
		fConst153 = (1.0 / (fConst150 * fConst152));
		fConst154 = (0.0 - (67801.035800023572 / (fConst3 * fConst152)));
		fConst155 = (0.0 - (((67801.035800023572 / fConst2) + 376.79993009206873) / (fConst2 * fConst152)));
		fConst156 = ((51.22606308695044 / fConst2) + 1.0);
		fConst157 = (1.0 / fConst156);
		fConst158 = (0.0 - (102.45212617390088 / (fConst2 * fConst156)));
		fConst159 = ((((7872.3286181646799 / fConst2) + 153.67818926085133) / fConst2) + 1.0);
		fConst160 = (1.0 / fConst159);
		fConst161 = (0.0 - (31489.31447265872 / (fConst3 * fConst159)));
		fConst162 = (0.0 - (((31489.31447265872 / fConst2) + 307.35637852170265) / (fConst2 * fConst159)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("KMH114_AEC_7h7v_full_2");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp11 = (((fTemp1 * (fRec7[2] + (fRec7[0] + (2.0 * fRec7[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec7[1]) + ((fRec7[0] + fRec7[2]) / fTemp4))))));
			fRec8[0] = (double(input0[i]) - (((fRec8[2] * fTemp2) + (2.0 * (fRec8[1] * fTemp3))) / fTemp4));
			double fTemp12 = (((fTemp1 * (fRec8[2] + (fRec8[0] + (2.0 * fRec8[1])))) / fTemp5) + (0.84178367409999999 * (fRec3[0] * (0.0 - ((fRec8[1] * fTemp6) + ((fRec8[0] + fRec8[2]) / fTemp4))))));
			...
			double fTemp29 = (((fTemp1 * (fRec39[2] + (fRec39[0] + (2.0 * fRec39[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec39[1]) + ((fRec39[0] + fRec39[2]) / fTemp4))))));
			double fTemp30 = (fConst11 * ((((((((0.063971423499999999 * fTemp17) + (0.0060244519999999996 * fTemp18)) + (0.0050544858999999999 * fTemp19)) + (0.0545846834 * fTemp20)) + (0.032622210700000001 * fTemp21)) + (0.020739416199999999 * fTemp22)) + (0.0081387765000000001 * fTemp23)) - ((((((0.077810576500000006 * fTemp24) + (0.0044162921000000001 * fTemp25)) + (0.044185148700000003 * fTemp26)) + (0.0059662214 * fTemp27)) + (0.0068283939000000002 * fTemp28)) + (0.10827278780000001 * fTemp29))));
			...
			double fTemp44 = (((fTemp1 * (fRec63[2] + (fRec63[0] + (2.0 * fRec63[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec63[1]) + ((fRec63[0] + fRec63[2]) / fTemp4))))));
			double fTemp45 = (fConst20 * ((((((0.1002941181 * fTemp36) + (0.0071552856000000001 * fTemp37)) + (0.0299835728 * fTemp38)) + (0.057700796999999998 * fTemp39)) + (0.019183279300000002 * fTemp40)) - ((((0.077892956200000002 * fTemp41) + (0.013003345100000001 * fTemp42)) + (0.0062647051999999998 * fTemp43)) + (0.073728940500000006 * fTemp44))));
			...
			fRec81[0] = (double(input17[i]) - (((fTemp2 * fRec81[2]) + (2.0 * (fTemp3 * fRec81[1]))) / fTemp4));
			...
			fRec83[0] = (double(input22[i]) - (((fTemp2 * fRec83[2]) + (2.0 * (fTemp3 * fRec83[1]))) / fTemp4));
			...
			double fTemp58 = (((fTemp1 * (fRec84[2] + (fRec84[0] + (2.0 * fRec84[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec84[1]) + ((fRec84[0] + fRec84[2]) / fTemp4))))));
			double fTemp59 = (fConst27 * ((((((0.115993159 * fTemp50) + (0.0058333376999999999 * fTemp51)) + (0.042268896600000001 * fTemp52)) + (0.0078805892999999991 * fTemp53)) + (0.0080886094000000002 * fTemp54)) - ((((0.0059873176 * fTemp55) + (0.062073267000000001 * fTemp56)) + (0.040269731099999997 * fTemp57)) + (0.0091806454999999992 * fTemp58))));
			...
			double fTemp68 = (((fTemp1 * (fRec99[2] + (fRec99[0] + (2.0 * fRec99[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec99[1]) + ((fRec99[0] + fRec99[2]) / fTemp4))))));
			double fTemp69 = (fConst33 * ((((0.1114693499 * fTemp63) + (0.0120718274 * fTemp64)) + (0.017973904299999999 * fTemp65)) - (((0.0075805105000000001 * fTemp66) + (0.0337376879 * fTemp67)) + (0.067327399400000001 * fTemp68))));
			...
			double fTemp74 = (((fTemp1 * (fRec105[2] + (fRec105[0] + (2.0 * fRec105[1])))) / fTemp5) + (0.80835632359999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec105[1]) + ((fRec105[0] + fRec105[2]) / fTemp4))))));
			double fTemp75 = (fConst37 * (((0.050203705000000001 * fTemp72) + (0.10333939609999999 * fTemp73)) - (0.0118274581 * fTemp74)));
			...
			double fTemp81 = (((fTemp1 * (fRec116[2] + (fRec116[0] + (2.0 * fRec116[1])))) / fTemp5) + (0.74349273000000005 * (fRec3[0] * (0.0 - ((fTemp6 * fRec116[1]) + ((fRec116[0] + fRec116[2]) / fTemp4))))));
			double fTemp82 = (fConst40 * (((0.088830286199999997 * fTemp77) + (0.062385599200000003 * fTemp78)) - (((0.0054813967999999998 * fTemp79) + (0.049683330900000003 * fTemp80)) + (0.0074051322000000001 * fTemp81))));
			...
			fVec0[(IOTA & 127)] = (((0.056588621300000003 * fTemp7) + ((0.00080973229999999996 * fTemp8) + ((0.0059190366000000001 * fTemp9) + ((0.067206093999999994 * fTemp10) + ((0.0077562322999999997 * fTemp11) + (((0.085793202999999998 * fTemp12) + (fRec10 + (fRec41 + (fRec65 + (fRec86 + (fRec101 + fRec107)))))) + (0.0161537543 * fTemp85))))))) - ((((((0.062959317299999998 * fTemp86) + (0.0045980943000000002 * fTemp87)) + (0.0281640742 * fTemp88)) + (0.0527308649 * fTemp89)) + (0.0144448561 * fTemp90)) + (0.115277566 * fTemp91)));
			...
			double fTemp96 = (fConst51 * ((((0.0007688708 * fTemp28) + ((0.064436733999999996 * fTemp21) + ((((3.5760299999999997e-05 * fTemp18) + (0.0025911059000000001 * fTemp24)) + (3.00027e-05 * fTemp19)) + (0.00067179100000000003 * fTemp27)))) + (0.1232803874 * fTemp29)) - ((0.00091641870000000003 * fTemp23) + (((0.027147285300000001 * fTemp26) + (((0.0041685031999999997 * fTemp17) + (0.0013321876000000001 * fTemp20)) + (2.6214500000000001e-05 * fTemp25))) + (0.083423740900000001 * fTemp22)))));
			...
			double fTemp102 = (fConst60 * ((((0.0021806841 * fTemp41) + (0.049722290099999997 * fTemp39)) + (0.13358176690000001 * fTemp44)) - ((0.0024705263999999999 * fTemp40) + (((((0.0042227304000000002 * fTemp36) + (2.5328000000000001e-06 * fTemp37)) + (0.00068322320000000001 * fTemp38)) + (0.00097221839999999998 * fTemp42)) + (0.082044925000000005 * fTemp43)))));
			...
			double fTemp107 = (fConst67 * (((((0.0016426093000000001 * fTemp56) + (3.4625900000000003e-05 * fTemp51)) + (0.0281385174 * fTemp52)) + (0.12156151 * fTemp58)) - ((0.00091076999999999998 * fTemp54) + ((0.079542431299999994 * fTemp57) + (((0.0038625927 * fTemp50) + (3.5539900000000002e-05 * fTemp55)) + (0.00088734709999999995 * fTemp53))))));
			...
			double fTemp111 = (fConst73 * ((((2.6833000000000002e-06 * fTemp66) + (0.00088908110000000004 * fTemp67)) + (0.12308288689999999 * fTemp65)) - (((0.0033342431999999998 * fTemp63) + (0.0042015346 * fTemp64)) + (0.063531470399999998 * fTemp68))));
			...
			double fTemp114 = (fConst77 * ((0.1044902623 * fTemp73) - ((0.0014808880000000001 * fTemp72) + (0.0011236554 * fTemp74))));
			double fTemp115 = (fConst78 * fRec178[1]);
			fRec180[0] = (fTemp114 + (fRec180[1] + fTemp115));
			fRec178[0] = fRec180[0];
			double fRec179 = (fTemp115 + fTemp114);
			double fTemp116 = (fConst80 * (((0.00083381099999999995 * fTemp81) + (0.12322660470000001 * fTemp78)) - (((0.0025421236000000001 * fTemp77) + (3.2536800000000003e-05 * fTemp79)) + (0.044553696499999997 * fTemp80))));
			...
			fVec1[(IOTA & 63)] = (((0.1172269085 * fTemp91) + ((0.0018602866 * fTemp90) + ((0.067895154299999996 * fTemp8) + ((0.00056821279999999996 * fTemp88) + ((1.6276000000000001e-06 * fTemp87) + (((0.0829148782 * fTemp12) + (fRec125 + (fRec143 + (fRec158 + (fRec170 + (fRec179 + fRec182)))))) + (0.0028881257999999999 * fTemp86))))))) - (((0.042068959599999997 * fTemp89) + ((((0.0035248342999999998 * fTemp85) + (2.7454999999999998e-06 * fTemp11)) + (0.0017725576999999999 * fTemp10)) + (0.0034091449000000001 * fTemp9))) + (0.091186757800000004 * fTemp7)));
			...
			double fTemp123 = (fConst91 * (((0.0087600847000000003 * fTemp23) + ((((0.075975978700000002 * fTemp24) + (0.005446747 * fTemp25)) + (0.031881768400000003 * fTemp21)) + (0.027371181500000001 * fTemp22))) - ((((0.0064216784000000002 * fTemp27) + (((((0.048714747599999997 * fTemp17) + (0.0074301391999999997 * fTemp18)) + (0.0062338506999999998 * fTemp19)) + (0.0568294378 * fTemp20)) + (0.044950641100000001 * fTemp26))) + (0.0073496684000000003 * fTemp28)) + (0.11432131449999999 * fTemp29))));
			...
			double fTemp129 = (fConst100 * ((((0.078993142399999994 * fTemp41) + (0.058063390800000003 * fTemp39)) + (0.020170910800000001 * fTemp40)) - ((((((0.091964728699999998 * fTemp36) + (0.0086251689000000006 * fTemp37)) + (0.031478071900000001 * fTemp38)) + (0.0135545925 * fTemp42)) + (0.0026842034000000002 * fTemp43)) + (0.0824061091 * fTemp44))));
			...
			double fTemp134 = (fConst107 * ((((0.0084821876999999993 * fTemp53) + (((0.0073843401999999997 * fTemp55) + (0.063753946399999997 * fTemp56)) + (0.0428939422 * fTemp52))) + (0.0087060878999999994 * fTemp54)) - ((((0.1132583021 * fTemp50) + (0.0071944321999999998 * fTemp51)) + (0.0393557093 * fTemp57)) + (0.017947649600000001 * fTemp58))));
			...
			double fTemp138 = (fConst113 * (((((0.0091377461999999996 * fTemp66) + (0.034650707199999999 * fTemp67)) + (0.0128115496 * fTemp64)) + (0.0132097736 * fTemp65)) - ((0.111664157 * fTemp63) + (0.067354046200000003 * fTemp68))));
			...
			double fTemp141 = (fConst117 * ((0.10287862909999999 * fTemp73) - ((0.0505537421 * fTemp72) + (0.0123181661 * fTemp74))));
			double fTemp142 = (fConst118 * fRec241[1]);
			fRec243[0] = (fTemp141 + (fRec243[1] + fTemp142));
			fRec241[0] = fRec243[0];
			double fRec242 = (fTemp142 + fTemp141);
			double fTemp143 = (fConst120 * (((0.0067603728 * fTemp79) + (0.0609696027 * fTemp78)) - (((0.089927550800000006 * fTemp77) + (0.049897220700000001 * fTemp80)) + (0.0079704344999999999 * fTemp81))));
			...
			fVec2[(IOTA & 63)] = (((0.062972572300000001 * fTemp7) + ((0.0063419886999999996 * fTemp9) + ((0.0300377405 * fTemp88) + ((0.0055426633999999999 * fTemp87) + ((0.056167613900000003 * fTemp86) + ((0.0044342506999999996 * fTemp85) + ((0.085876816600000003 * fTemp12) + (fRec188 + (fRec206 + (fRec221 + (fRec233 + (fRec242 + fRec245)))))))))))) - (((0.015188534700000001 * fTemp90) + ((0.0024630525 * fTemp8) + (((0.0093495657999999992 * fTemp11) + (0.068859096199999997 * fTemp10)) + (0.053304578599999999 * fTemp89)))) + (0.1144914678 * fTemp91)));
			...
			double fTemp150 = (fConst131 * (((0.096669202300000007 * fTemp29) + ((0.012190559700000001 * fTemp23) + (((0.0044649868999999997 * fTemp17) + (0.0070454682000000001 * fTemp25)) + (0.049336884999999997 * fTemp22)))) - ((0.010227820300000001 * fTemp28) + ((0.034563215799999998 * fTemp21) + ((0.0089364266000000001 * fTemp27) + (((((0.0096110229000000002 * fTemp18) + (0.068807196599999995 * fTemp24)) + (0.0080636014000000002 * fTemp19)) + (0.071098333 * fTemp20)) + (0.050789320700000001 * fTemp26)))))));
			...
			double fTemp156 = (fConst140 * (((0.052503883500000001 * fTemp44) + ((0.0255572913 * fTemp40) + (((0.087249020299999994 * fTemp36) + (0.036447598800000001 * fTemp39)) + (0.086301936600000004 * fTemp43)))) - ((((0.00035152730000000002 * fTemp41) + (0.016297524899999999 * fTemp37)) + (0.059498686100000003 * fTemp38)) + (0.016764241199999998 * fTemp42))));
			...
			double fTemp161 = (fConst147 * (((0.012115417700000001 * fTemp54) + ((0.042665759900000003 * fTemp57) + ((0.011803837399999999 * fTemp53) + ((((0.1025717127 * fTemp50) + (0.0095517810000000005 * fTemp55)) + (0.075676780099999993 * fTemp56)) + (0.047852290999999998 * fTemp52))))) - ((0.0093061315000000002 * fTemp51) + (0.044589082199999998 * fTemp58))));
			...
			double fTemp165 = (fConst153 * (((((0.010572071800000001 * fTemp63) + (0.017266055700000001 * fTemp66)) + (0.068577900799999994 * fTemp67)) + (0.016642637799999999 * fTemp64)) - ((0.037626746199999998 * fTemp68) + (0.1177408154 * fTemp65))));
			...
			double fTemp168 = (fConst157 * ((0.051549827999999999 * fTemp73) - ((0.1041865167 * fTemp72) + (0.0151976431 * fTemp74))));
			double fTemp169 = (fConst158 * fRec304[1]);
			fRec306[0] = (fTemp168 + (fRec306[1] + fTemp169));
			fRec304[0] = fRec306[0];
			double fRec305 = (fTemp169 + fTemp168);
			double fTemp170 = (fConst160 * ((0.0087446675000000008 * fTemp79) - ((((0.1005351922 * fTemp77) + (0.053603893999999999 * fTemp80)) + (0.011091680200000001 * fTemp81)) + (0.066097510999999998 * fTemp78))));
			...
			fVec3[0] = (((0.046478797299999999 * fTemp91) + ((0.0084454643000000003 * fTemp9) + ((0.054891890999999998 * fTemp88) + (((0.090803430899999996 * fTemp12) + (fRec251 + (fRec269 + (fRec284 + (fRec296 + (fRec305 + fRec308)))))) + (0.010473035 * fTemp87))))) - ((0.025548894499999999 * fTemp7) + ((0.019244436199999999 * fTemp90) + ((0.077400766600000004 * fTemp8) + (((((0.086160961600000002 * fTemp85) + (0.017666295500000002 * fTemp11)) + (0.066949017999999999 * fTemp86)) + (0.0048330163000000004 * fTemp10)) + (0.036304723499999997 * fTemp89))))));
			...
			double fTemp177 = (fConst51 * ((((5.5565900000000003e-05 * fTemp25) + (((0.1194567051 * fTemp17) + (0.063842560100000001 * fTemp24)) + (0.021637947300000002 * fTemp20))) + (0.0046406965999999999 * fTemp23)) - (((0.044790909400000002 * fTemp22) + ((0.0038935218999999999 * fTemp28) + ((0.055202097700000001 * fTemp21) + ((0.0034019147 * fTemp27) + (((7.5799799999999999e-05 * fTemp18) + (6.3595600000000005e-05 * fTemp19)) + (0.038620143199999998 * fTemp26)))))) + (0.0100509508 * fTemp29))));
			...
			double fTemp183 = (fConst60 * ((0.0077172836999999999 * fTemp40) - ((((((((0.043220842799999999 * fTemp36) + (0.064594664400000001 * fTemp41)) + (0.0060117646000000004 * fTemp37)) + (0.0592554816 * fTemp38)) + (0.0071243556 * fTemp42)) + (0.012331582000000001 * fTemp39)) + (0.043454650099999999 * fTemp43)) + (0.1112085418 * fTemp44))));
			...
			double fTemp188 = (fConst67 * (((0.075514508800000005 * fTemp58) + ((0.0046120915999999998 * fTemp54) + ((0.068142948800000006 * fTemp57) + ((0.0044934793000000004 * fTemp53) + ((7.5332499999999997e-05 * fTemp55) + (0.037853145900000003 * fTemp52)))))) - (((0.095170869500000005 * fTemp50) + (0.031169769 * fTemp56)) + (7.3395199999999998e-05 * fTemp51))));
			...
			double fTemp192 = (fConst73 * ((((((0.097737141 * fTemp63) + (0.0063690322999999998 * fTemp66)) + (0.0749002099 * fTemp67)) + (0.0029631909 * fTemp64)) + (0.0188250799 * fTemp68)) + (0.070545380399999996 * fTemp65)));
			...
			double fTemp195 = (fConst80 * (((0.054449248800000002 * fTemp77) + (6.8967000000000006e-05 * fTemp79)) - (((0.052202973799999997 * fTemp80) + (0.0042223757000000002 * fTemp81)) + (0.10556660230000001 * fTemp78))));
			double fTemp196 = (fConst81 * fRec367[1]);
			double fTemp197 = (fConst82 * fRec370[1]);
			fRec372[0] = (fTemp195 + (fTemp196 + (fRec372[1] + fTemp197)));
			fRec370[0] = fRec372[0];
			double fRec371 = ((fTemp197 + fTemp196) + fTemp195);
			fRec369[0] = (fRec370[0] + fRec369[1]);
			fRec367[0] = fRec369[0];
			double fRec368 = fRec371;
			double fTemp198 = (fConst77 * (0.0 - (((0.1222500083 * fTemp72) + (0.0066513053999999999 * fTemp74)) + (0.034507818900000001 * fTemp73))));
			double fTemp199 = (fConst78 * fRec373[1]);
			fRec375[0] = (fTemp198 + (fRec375[1] + fTemp199));
			fRec373[0] = fRec375[0];
			double fRec374 = (fTemp199 + fTemp198);
			fVec4[(IOTA & 63)] = (((0.098505481500000006 * fTemp91) + ((0.079093964599999997 * fTemp7) + ((0.033228557200000002 * fTemp8) + ((0.0085575406 * fTemp89) + ((0.0004879711 * fTemp9) + ((0.050631219300000002 * fTemp88) + ((0.0038632505000000001 * fTemp87) + ((0.053029537600000003 * fTemp10) + (((0.093265817400000006 * fTemp12) + (fRec314 + (fRec332 + (fRec347 + (fRec359 + (fRec368 + fRec374)))))) + (0.029198492199999999 * fTemp86)))))))))) - (((0.039230482900000002 * fTemp85) + (0.0065166711000000004 * fTemp11)) + (0.0058110530000000001 * fTemp90)));
			...
			double fTemp204 = (fConst171 * ((((0.083294464999999998 * fTemp22) + ((((0.012755736300000001 * fTemp25) + ((0.023127161699999999 * fTemp24) + (0.084954150899999997 * fTemp20))) + (0.0152647688 * fTemp27)) + (0.017470664600000001 * fTemp28))) + (0.066254414100000006 * fTemp29)) - ((((((0.098175225399999996 * fTemp17) + (0.017400642599999998 * fTemp18)) + (0.0145990545 * fTemp19)) + (0.048287657300000002 * fTemp26)) + (0.0039694802000000001 * fTemp21)) + (0.020823320499999999 * fTemp23))));
			...
			double fTemp210 = (fConst180 * (((0.040165939800000001 * fTemp44) + ((((0.10108658230000001 * fTemp36) + (0.054258949200000003 * fTemp41)) + (0.027739468900000001 * fTemp37)) + (0.028406628499999999 * fTemp40))) - ((((0.048923264700000003 * fTemp38) + (0.017656144200000001 * fTemp42)) + (0.053355509699999998 * fTemp39)) + (0.064420743899999994 * fTemp43))));
			...
			double fTemp215 = (fConst187 * ((((0.0172933859 * fTemp55) + (0.045540015900000001 * fTemp52)) + (0.0049000327000000002 * fTemp57)) - ((0.091981577100000003 * fTemp58) + (((((0.034475937200000001 * fTemp50) + (0.084293557800000002 * fTemp56)) + (0.016848640299999999 * fTemp51)) + (0.0201627404 * fTemp53)) + (0.0206949666 * fTemp54)))));
			...
			double fTemp219 = (fConst193 * (((((0.0497847285 * fTemp67) + (0.019475208500000001 * fTemp64)) + (0.053011300099999999 * fTemp68)) + (0.075640936899999997 * fTemp65)) - ((0.063853410900000004 * fTemp63) + (0.029387972500000002 * fTemp66))));
			...
			double fTemp222 = (fConst197 * (0.0 - (((0.067174998999999999 * fTemp72) + (0.0159148889 * fTemp74)) + (0.069665973199999995 * fTemp73))));
			double fTemp223 = (fConst198 * fRec430[1]);
			fRec432[0] = (fTemp222 + (fRec432[1] + fTemp223));
			fRec430[0] = fRec432[0];
			double fRec431 = (fTemp223 + fTemp222);
			double fTemp224 = (fConst200 * ((((0.10215779279999999 * fTemp77) + (0.015832116600000001 * fTemp79)) + (0.018946267999999999 * fTemp81)) - ((0.047103844899999997 * fTemp80) + (0.0075910980000000001 * fTemp78))));
			...
			fVec5[0] = (((0.064024030699999998 * fTemp8) + ((0.054412001000000002 * fTemp89) + ((0.0103641468 * fTemp9) + ((0.049172424200000002 * fTemp88) + ((0.0300692072 * fTemp11) + ((0.010003436399999999 * fTemp85) + ((0.078905777499999996 * fTemp12) + (fRec377 + (fRec395 + (fRec410 + (fRec422 + (fRec431 + fRec434)))))))))))) - ((0.10549638059999999 * fTemp91) + ((0.044267838099999998 * fTemp7) + ((((0.082704671800000004 * fTemp86) + (0.053851279699999997 * fTemp10)) + (0.017825800499999999 * fTemp87)) + (0.021389964399999999 * fTemp90)))));
			...
			double fTemp231 = (fConst211 * ((((0.083266194099999996 * fTemp22) + (((((0.097115098699999999 * fTemp17) + (0.0174601848 * fTemp18)) + (0.0146490101 * fTemp19)) + (0.0152758853 * fTemp27)) + (0.017483387600000001 * fTemp28))) + (0.066377793700000007 * fTemp29)) - ((((0.048241667500000002 * fTemp26) + (((0.022687125499999999 * fTemp24) + (0.085090839900000007 * fTemp20)) + (0.012799384400000001 * fTemp25))) + (0.0039946888999999996 * fTemp21)) + (0.020838485 * fTemp23))));
			...
			double fTemp237 = (fConst220 * (((0.0402513642 * fTemp44) + ((0.048861553299999999 * fTemp38) + (0.028373359800000001 * fTemp40))) - ((((((0.10194936979999999 * fTemp36) + (0.053960597399999997 * fTemp41)) + (0.0276839571 * fTemp37)) + (0.017634608100000001 * fTemp42)) + (0.053411217099999998 * fTemp39)) + (0.064423983800000001 * fTemp43))));
			...
			double fTemp242 = (fConst227 * ((((((0.033819969900000003 * fTemp50) + (0.084503466999999999 * fTemp56)) + (0.016906293700000002 * fTemp51)) + (0.045501244199999999 * fTemp52)) + (0.0049311509999999999 * fTemp57)) - ((0.091977128699999994 * fTemp58) + (((0.017352560999999999 * fTemp55) + (0.0201774238 * fTemp53)) + (0.020710037600000002 * fTemp54)))));
			...
			double fTemp246 = (fConst233 * ((((((0.063340141899999994 * fTemp63) + (0.029329161699999998 * fTemp66)) + (0.019453258000000001 * fTemp64)) + (0.053071221000000002 * fTemp68)) + (0.075629992899999998 * fTemp65)) - (0.049665268700000001 * fTemp67)));
			...
			double fTemp249 = (fConst237 * ((0.066931594900000002 * fTemp72) - ((0.015895392099999999 * fTemp74) + (0.069751515400000005 * fTemp73))));
			double fTemp250 = (fConst238 * fRec493[1]);
			fRec495[0] = (fTemp249 + (fRec495[1] + fTemp250));
			fRec493[0] = fRec495[0];
			double fRec494 = (fTemp250 + fTemp249);
			double fTemp251 = (fConst240 * ((0.018960065599999999 * fTemp81) - ((((0.10253987489999999 * fTemp77) + (0.0158862915 * fTemp79)) + (0.047066094000000003 * fTemp80)) + (0.0076393062999999999 * fTemp78))));
			...
			output6[i] = FAUSTFLOAT((fRec0[0] * (((0.064034773899999994 * fTemp8) + ((0.054466015999999999 * fTemp89) + ((0.010352866699999999 * fTemp9) + ((0.017790127699999998 * fTemp87) + ((0.053637889399999999 * fTemp10) + (((0.078850770599999995 * fTemp12) + (fRec440 + (fRec458 + (fRec473 + (fRec485 + (fRec494 + fRec497)))))) + (0.083337606999999994 * fTemp86))))))) - ((0.10536755189999999 * fTemp91) + ((0.044338105799999999 * fTemp7) + ((((0.0111323169 * fTemp85) + (0.0300090332 * fTemp11)) + (0.0491450368 * fTemp88)) + (0.0213649133 * fTemp90)))))));
			...
			double fTemp258 = (fConst250 * ((((7.3256499999999999e-05 * fTemp18) + (6.1461899999999995e-05 * fTemp19)) + (0.0046514175000000003 * fTemp23)) - (((0.044738174300000003 * fTemp22) + ((0.0039025167000000002 * fTemp28) + ((0.055184112 * fTemp21) + ((0.0034097737999999999 * fTemp27) + ((0.0386516898 * fTemp26) + ((((0.11891233399999999 * fTemp17) + (0.064241274599999995 * fTemp24)) + (0.021407530099999999 * fTemp20)) + (5.3701500000000001e-05 * fTemp25))))))) + (0.0101503798 * fTemp29))));
			...
			double fTemp264 = (fConst259 * ((((((0.043825502600000003 * fTemp36) + (0.064236792700000003 * fTemp41)) + (0.0060164637999999999 * fTemp37)) + (0.059375882400000003 * fTemp38)) + (0.0077385290999999997 * fTemp40)) - ((((0.0071377495999999999 * fTemp42) + (0.012294392100000001 * fTemp39)) + (0.043440063700000003 * fTemp43)) + (0.11130178960000001 * fTemp44))));
			...
			double fTemp269 = (fConst266 * (((0.075459968299999999 * fTemp58) + ((0.0046227463999999998 * fTemp54) + ((0.068120746699999998 * fTemp57) + ((0.0045038602000000002 * fTemp53) + ((((0.095765237899999994 * fTemp50) + (0.0308888215 * fTemp56)) + (7.0932600000000006e-05 * fTemp51)) + (0.037881308199999998 * fTemp52)))))) - (7.2805000000000005e-05 * fTemp55)));
			...
			double fTemp273 = (fConst272 * ((((0.0029775675000000001 * fTemp64) + (0.018785492300000001 * fTemp68)) + (0.070534527799999996 * fTemp65)) - (((0.097193432799999993 * fTemp63) + (0.0063740107999999997 * fTemp66)) + (0.075054274500000004 * fTemp67))));
			...
			double fTemp276 = (fConst276 * ((0.1225036588 * fTemp72) - ((0.0066633971000000002 * fTemp74) + (0.034451874299999997 * fTemp73))));
			double fTemp277 = (fConst277 * fRec556[1]);
			fRec558[0] = (fTemp276 + (fRec558[1] + fTemp277));
			fRec556[0] = fRec558[0];
			double fRec557 = (fTemp277 + fTemp276);
			double fTemp278 = (fConst279 * (0.0 - (((((0.054018822899999999 * fTemp77) + (6.6653e-05 * fTemp79)) + (0.052230780900000003 * fTemp80)) + (0.0042321301999999998 * fTemp81)) + (0.105532207 * fTemp78))));
			...
			fVec6[(IOTA & 127)] = (((0.098446619999999999 * fTemp91) + ((0.079165885000000005 * fTemp7) + ((0.0332108599 * fTemp8) + ((0.0085212267000000005 * fTemp89) + ((0.00049553349999999999 * fTemp9) + ((0.0065217649999999997 * fTemp11) + ((0.039635545699999997 * fTemp85) + ((0.093309420399999995 * fTemp12) + (fRec503 + (fRec521 + (fRec536 + (fRec548 + (fRec557 + fRec560))))))))))))) - (((((0.029609934300000001 * fTemp86) + (0.052736871300000002 * fTemp10)) + (0.0038662702999999999 * fTemp87)) + (0.050732949999999999 * fTemp88)) + (0.0058270505999999996 * fTemp90)));
			...
			double fTemp285 = (fConst290 * (((0.095489929500000001 * fTemp29) + ((0.012316732800000001 * fTemp23) + (((((0.0097322603000000001 * fTemp18) + (0.067778918300000005 * fTemp24)) + (0.0081653190000000007 * fTemp19)) + (0.071869299999999997 * fTemp20)) + (0.049753160599999999 * fTemp22)))) - ((0.010333678900000001 * fTemp28) + ((0.034320587100000001 * fTemp21) + ((0.0090289192000000008 * fTemp27) + ((0.051201709999999998 * fTemp26) + ((0.0037528799000000001 * fTemp17) + (0.0071343426000000003 * fTemp25))))))));
			...
			double fTemp291 = (fConst299 * (((0.051563728599999997 * fTemp44) + ((0.0258270572 * fTemp40) + ((((0.016442357800000001 * fTemp37) + (0.059915275800000001 * fTemp38)) + (0.036949083100000002 * fTemp39)) + (0.086382893000000002 * fTemp43)))) - (((0.085965375699999999 * fTemp36) + (0.00070896900000000005 * fTemp41)) + (0.016939064300000001 * fTemp42))));
			...
			double fTemp296 = (fConst306 * (((0.012240813 * fTemp54) + ((0.0423662525 * fTemp57) + ((0.0119260079 * fTemp53) + ((0.0094235228000000004 * fTemp51) + (0.0482136211 * fTemp52))))) - ((((0.1010388458 * fTemp50) + (0.0096722710999999992 * fTemp55)) + (0.076521050800000004 * fTemp56)) + (0.044903967699999998 * fTemp58))));
			...
			double fTemp300 = (fConst312 * ((0.016820435599999999 * fTemp64) - (((((0.0090954086000000003 * fTemp63) + (0.017419495600000001 * fTemp66)) + (0.069020551999999999 * fTemp67)) + (0.038173349799999999 * fTemp68)) + (0.1177313973 * fTemp65))));
			...
			double fTemp303 = (fConst316 * (((0.1048109616 * fTemp72) + (0.052340020399999999 * fTemp73)) - (0.015355930300000001 * fTemp74)));
			double fTemp304 = (fConst317 * fRec619[1]);
			fRec621[0] = (fTemp303 + (fRec621[1] + fTemp304));
			fRec619[0] = fRec621[0];
			double fRec620 = (fTemp304 + fTemp303);
			double fTemp305 = (fConst319 * ((0.1016946965 * fTemp77) - ((((0.0088549764000000006 * fTemp79) + (0.053973043999999998 * fTemp80)) + (0.0112064798 * fTemp81)) + (0.065633516099999997 * fTemp78))));
			...
			fVec7[(IOTA & 63)] = (((0.045474278899999998 * fTemp91) + ((0.0085367381999999995 * fTemp9) + ((0.0057689118000000001 * fTemp10) + ((0.066179402600000006 * fTemp86) + ((0.017823292300000002 * fTemp11) + ((0.086145407399999999 * fTemp85) + ((0.091374964599999997 * fTemp12) + (fRec566 + (fRec584 + (fRec599 + (fRec611 + (fRec620 + fRec623)))))))))))) - ((0.024808943199999999 * fTemp7) + ((0.019447567799999999 * fTemp90) + ((0.077534518199999999 * fTemp8) + (((0.010566106699999999 * fTemp87) + (0.055299154699999999 * fTemp88)) + (0.036786577700000003 * fTemp89))))));
			...
			double fTemp312 = (fConst330 * (((0.054311168999999999 * fTemp28) + ((0.0058440751000000003 * fTemp21) + ((0.047453686299999999 * fTemp27) + ((0.045032318699999997 * fTemp25) + (0.0412062422 * fTemp26))))) - ((0.0096641259000000007 * fTemp29) + ((0.064733592300000004 * fTemp23) + ((((((0.074613563999999993 * fTemp17) + (0.061430501700000001 * fTemp18)) + (0.0022089026999999998 * fTemp24)) + (0.051539892099999998 * fTemp19)) + (0.044281532499999998 * fTemp20)) + (0.014172077199999999 * fTemp22))))));
			...
			double fTemp318 = (fConst339 * ((0.049151849300000001 * fTemp42) - ((0.0531247501 * fTemp44) + ((0.089989177399999995 * fTemp40) + ((((((0.055222765899999998 * fTemp36) + (0.0016213164 * fTemp41)) + (0.080083902299999996 * fTemp37)) + (0.023019839300000001 * fTemp38)) + (0.026904253499999999 * fTemp39)) + (0.0055148289000000001 * fTemp43))))));
			...
			double fTemp323 = (fConst346 * (((0.0032928377000000001 * fTemp50) + (0.061051846999999999 * fTemp55)) - ((0.080836860100000005 * fTemp58) + ((0.064334577500000004 * fTemp54) + ((0.0072140829999999996 * fTemp57) + ((((0.0047409972999999999 * fTemp56) + (0.059481736100000002 * fTemp51)) + (0.025067285500000001 * fTemp52)) + (0.062680042399999997 * fTemp53)))))));
			...
			double fTemp327 = (fConst352 * (((0.066627497899999999 * fTemp63) + (0.084843135299999997 * fTemp66)) - ((((0.013595226300000001 * fTemp67) + (0.068476326700000006 * fTemp64)) + (0.0109784615 * fTemp68)) + (0.059289391099999998 * fTemp65))));
			...
			double fTemp330 = (fConst356 * (((0.072060592600000001 * fTemp72) + (0.043635737700000003 * fTemp74)) + (0.070468366300000002 * fTemp73)));
			double fTemp331 = (fConst357 * fRec682[1]);
			fRec684[0] = (fTemp330 + (fRec684[1] + fTemp331));
			fRec682[0] = fRec684[0];
			double fRec683 = (fTemp331 + fTemp330);
			double fTemp332 = (fConst359 * (((((0.089419951999999997 * fTemp77) + (0.055893043000000003 * fTemp79)) + (0.058898386900000002 * fTemp81)) + (0.011176009299999999 * fTemp78)) - (0.025533738600000001 * fTemp80)));
			...
			fVec8[(IOTA & 255)] = (((0.046865103399999997 * fTemp91) + ((0.067761131899999993 * fTemp90) + ((0.039028175700000001 * fTemp8) + ((0.0504892308 * fTemp89) + ((0.045768284899999997 * fTemp88) + (((0.0791994949 * fTemp12) + (fRec629 + (fRec647 + (fRec662 + (fRec674 + (fRec683 + fRec686)))))) + (0.051463121600000002 * fTemp87))))))) - ((((((0.068196870000000007 * fTemp85) + (0.086809861500000002 * fTemp11)) + (0.0129877463 * fTemp86)) + (0.031404978799999997 * fTemp10)) + (0.039613452100000002 * fTemp9)) + (0.017116682899999999 * fTemp7)));
			...
			double fTemp339 = (fConst330 * (((0.054616734 * fTemp28) + ((0.0052193257000000002 * fTemp21) + ((0.047720669799999997 * fTemp27) + ((((((0.072651582800000003 * fTemp17) + (0.061923564299999997 * fTemp18)) + (0.0015947025999999999 * fTemp24)) + (0.051953569200000001 * fTemp19)) + (0.045357650800000003 * fTemp20)) + (0.042283829199999998 * fTemp26))))) - ((0.0065715408999999997 * fTemp29) + ((0.065097795900000005 * fTemp23) + ((0.0453937638 * fTemp25) + (0.015361517099999999 * fTemp22))))));
			...
			double fTemp345 = (fConst339 * ((((((0.055028614699999999 * fTemp36) + (0.00050635719999999999 * fTemp41)) + (0.080610110799999996 * fTemp37)) + (0.023637853 * fTemp38)) + (0.0496371247 * fTemp42)) - ((0.0506052554 * fTemp44) + ((0.090749558300000005 * fTemp40) + ((0.0281954344 * fTemp39) + (0.0057588563000000002 * fTemp43))))));
			...
			double fTemp350 = (fConst346 * (((0.0038029304000000001 * fTemp56) + (0.059959157200000002 * fTemp51)) - ((0.079925306700000004 * fTemp58) + ((0.064696536200000002 * fTemp54) + ((0.0064428756 * fTemp57) + ((((0.0023772422 * fTemp50) + (0.061541870399999997 * fTemp55)) + (0.026000478399999999 * fTemp52)) + (0.063032692299999998 * fTemp53)))))));
			...
			double fTemp354 = (fConst352 * ((0.013156325599999999 * fTemp67) - (((((0.065456939300000003 * fTemp63) + (0.085400615400000005 * fTemp66)) + (0.068984973300000002 * fTemp64)) + (0.0095984672000000004 * fTemp68)) + (0.059300938999999997 * fTemp65))));
			...
			double fTemp357 = (fConst356 * (((0.044074403599999999 * fTemp74) + (0.068510448599999996 * fTemp73)) - (0.071744061999999997 * fTemp72)));
			double fTemp358 = (fConst357 * fRec745[1]);
			fRec747[0] = (fTemp357 + (fRec747[1] + fTemp358));
			fRec745[0] = fRec747[0];
			double fRec746 = (fTemp358 + fTemp357);
			double fTemp359 = (fConst359 * (((0.059229760499999999 * fTemp81) + (0.0099812598999999991 * fTemp78)) - (((0.0885059978 * fTemp77) + (0.056341660100000003 * fTemp79)) + (0.0246244142 * fTemp80))));
			...
			fVec9[(IOTA & 255)] = (((0.049361907599999998 * fTemp91) + ((0.068333692700000004 * fTemp90) + ((0.039422752999999998 * fTemp8) + ((0.051746593 * fTemp89) + ((0.032583770099999999 * fTemp10) + ((0.013523504400000001 * fTemp86) + ((0.087380264299999996 * fTemp11) + ((0.064544605899999996 * fTemp85) + ((0.077828425100000001 * fTemp12) + (fRec692 + (fRec710 + (fRec725 + (fRec737 + (fRec746 + fRec749)))))))))))))) - (((0.039878216299999998 * fTemp9) + ((0.051801271099999997 * fTemp87) + (0.046505593300000002 * fTemp88))) + (0.0191210401 * fTemp7)));
			...
			double fTemp366 = (fConst370 * ((((((0.065015683899999996 * fTemp18) + (0.054547842499999999 * fTemp19)) + (0.0380870024 * fTemp26)) + (0.0047680066999999998 * fTemp21)) + (0.065259408800000002 * fTemp23)) - (((0.029868916499999999 * fTemp22) + ((((((0.050760389599999997 * fTemp17) + (0.0087008150000000006 * fTemp24)) + (0.049958686500000002 * fTemp20)) + (0.047660476799999997 * fTemp25)) + (0.047839142000000001 * fTemp27)) + (0.054752326499999997 * fTemp28))) + (0.0197702334 * fTemp29))));
			...
			double fTemp372 = (fConst379 * (((((0.0191221601 * fTemp39) + (((0.032410522999999997 * fTemp36) + (0.022116795799999998 * fTemp38)) + (0.049093735300000003 * fTemp42))) + (0.013537783100000001 * fTemp43)) + (0.055270547699999999 * fTemp44)) - (((0.0070894030000000002 * fTemp41) + (0.084547580600000005 * fTemp37)) + (0.0909173707 * fTemp40))));
			...
			double fTemp377 = (fConst386 * (((((0.0129704092 * fTemp50) + (0.062953185199999998 * fTemp51)) + (0.063189178299999996 * fTemp53)) + (0.064857152900000006 * fTemp54)) - (((((0.064614930400000006 * fTemp55) + (0.0010439595000000001 * fTemp56)) + (0.0223159276 * fTemp52)) + (0.0058857552000000004 * fTemp57)) + (0.058489094499999998 * fTemp58))));
			...
			double fTemp381 = (fConst392 * (((((0.089572081499999998 * fTemp66) + (0.017230311000000002 * fTemp67)) + (0.0211877234 * fTemp68)) + (0.047709143799999999 * fTemp65)) - ((0.057203559399999999 * fTemp63) + (0.069747716400000007 * fTemp64))));
			...
			double fTemp384 = (fConst396 * ((0.043520727799999999 * fTemp74) - ((0.080906551800000004 * fTemp72) + (0.087566796899999993 * fTemp73))));
			double fTemp385 = (fConst397 * fRec808[1]);
			fRec810[0] = (fTemp384 + (fRec810[1] + fTemp385));
			fRec808[0] = fRec810[0];
			double fRec809 = (fTemp385 + fTemp384);
			double fTemp386 = (fConst399 * (((0.088267195699999995 * fTemp77) + (0.0091181727999999993 * fTemp78)) - (((0.059155050299999998 * fTemp79) + (0.031128870400000001 * fTemp80)) + (0.059376805400000003 * fTemp81))));
			...
			fVec10[(IOTA & 255)] = (((0.016095146800000001 * fTemp7) + ((0.068460054100000001 * fTemp90) + ((0.0543315485 * fTemp87) + ((0.040472150200000001 * fTemp10) + ((0.031371599399999998 * fTemp86) + ((0.046116872400000002 * fTemp85) + ((0.088984654100000005 * fTemp12) + (fRec755 + (fRec773 + (fRec788 + (fRec800 + (fRec809 + fRec812)))))))))))) - (((0.045899918900000003 * fTemp8) + ((0.0440675045 * fTemp89) + ((0.040587135699999999 * fTemp9) + ((0.091648428099999998 * fTemp11) + (0.046521065100000002 * fTemp88))))) + (0.018631306399999999 * fTemp91)));
			...
			double fTemp393 = (fConst330 * (((((0.037982428499999998 * fTemp26) + ((0.047591003899999998 * fTemp25) + (((0.050157399800000002 * fTemp17) + (0.0087073415999999997 * fTemp24)) + (0.050108575900000001 * fTemp20)))) + (0.0048274370000000004 * fTemp21)) + (0.065293496899999998 * fTemp23)) - (((0.029776692 * fTemp22) + ((((0.064920912999999997 * fTemp18) + (0.054468330199999998 * fTemp19)) + (0.0478641307 * fTemp27)) + (0.054780926200000003 * fTemp28))) + (0.020061979300000001 * fTemp29))));
			...
			double fTemp399 = (fConst339 * (((((0.019248479799999999 * fTemp39) + (((0.0069734261999999997 * fTemp41) + (0.084647460499999994 * fTemp37)) + (0.0490466876 * fTemp42))) + (0.013554126999999999 * fTemp43)) + (0.055047966800000001 * fTemp44)) - (((0.0326637725 * fTemp36) + (0.022026662400000001 * fTemp38)) + (0.0908443263 * fTemp40))));
			...
			double fTemp404 = (fConst346 * (((((0.0645207436 * fTemp55) + (0.00093301929999999999 * fTemp56)) + (0.063222185 * fTemp53)) + (0.064891030899999994 * fTemp54)) - (((((0.0129801385 * fTemp50) + (0.062861420700000004 * fTemp51)) + (0.022225960499999999 * fTemp52)) + (0.0059591176000000001 * fTemp57)) + (0.0585438109 * fTemp58))));
			...
			double fTemp408 = (fConst352 * ((((0.057279892800000003 * fTemp63) + (0.021051641900000001 * fTemp68)) + (0.047720045799999999 * fTemp65)) - (((0.089677897100000001 * fTemp66) + (0.017278426600000001 * fTemp67)) + (0.069699285099999994 * fTemp64))));
			...
			double fTemp411 = (fConst356 * (((0.080908203900000003 * fTemp72) + (0.043478157599999998 * fTemp74)) - (0.087372244099999996 * fTemp73)));
			double fTemp412 = (fConst357 * fRec871[1]);
			fRec873[0] = (fTemp411 + (fRec873[1] + fTemp412));
			fRec871[0] = fRec873[0];
			double fRec872 = (fTemp412 + fTemp411);
			double fTemp413 = (fConst359 * (((0.059068822200000003 * fTemp79) + (0.0092318253999999992 * fTemp78)) - (((0.088197691199999997 * fTemp77) + (0.0312176568 * fTemp80)) + (0.059407820700000002 * fTemp81))));
			...
			fVec11[(IOTA & 255)] = (((0.0162737874 * fTemp7) + ((0.068405052199999997 * fTemp90) + ((0.046403816100000002 * fTemp88) + (((0.089117939100000002 * fTemp12) + (fRec818 + (fRec836 + (fRec851 + (fRec863 + (fRec872 + fRec875)))))) + (0.091756696499999998 * fTemp11))))) - (((0.045931512700000003 * fTemp8) + ((0.044189859800000002 * fTemp89) + (((((0.047022505899999997 * fTemp85) + (0.031122435399999999 * fTemp86)) + (0.040326360999999998 * fTemp10)) + (0.054395732799999999 * fTemp87)) + (0.040562132399999999 * fTemp9)))) + (0.0188971574 * fTemp91)));
			output12[i] = FAUSTFLOAT((0.89454976303317535 * (fRec0[0] * fVec11[((IOTA - iConst362) & 255)])));
			double fTemp416 = (fConst406 * (((0.0016552752 * fTemp22) + ((0.00042313620000000002 * fTemp28) + ((0.00052904670000000005 * fTemp21) + ((0.00036970980000000002 * fTemp27) + (((((8.7283999999999993e-06 * fTemp18) + (3.71923e-05 * fTemp24)) + (7.3231000000000002e-06 * fTemp19)) + (1.2394999999999999e-06 * fTemp20)) + (0.14371951250000001 * fTemp26)))))) - ((0.0022322090999999998 * fTemp29) + ((0.00050433689999999996 * fTemp23) + ((0.00013980629999999999 * fTemp17) + (6.3983999999999996e-06 * fTemp25))))));
			double fTemp417 = (fConst407 * fRec895[1]);
			double fTemp418 = (fConst408 * fRec892[1]);
			fRec897[0] = (((fTemp416 + fRec897[1]) + fTemp417) + fTemp418);
			fRec895[0] = fRec897[0];
			double fRec896 = ((fTemp416 + fTemp417) + fTemp418);
			fRec894[0] = (fRec895[0] + fRec894[1]);
			fRec892[0] = fRec894[0];
			double fRec893 = fRec896;
			double fTemp419 = (fConst409 * fRec889[1]);
			double fTemp420 = (fConst410 * fRec886[1]);
			fRec891[0] = (((fRec893 + fRec891[1]) + fTemp419) + fTemp420);
			fRec889[0] = fRec891[0];
			double fRec890 = ((fRec893 + fTemp419) + fTemp420);
			fRec888[0] = (fRec889[0] + fRec888[1]);
			fRec886[0] = fRec888[0];
			double fRec887 = fRec890;
			double fTemp421 = (fConst411 * fRec883[1]);
			double fTemp422 = (fConst412 * fRec880[1]);
			fRec885[0] = (((fRec887 + fRec885[1]) + fTemp421) + fTemp422);
			fRec883[0] = fRec885[0];
			double fRec884 = ((fRec887 + fTemp421) + fTemp422);
			...
			double fTemp426 = (fConst419 * (((0.0013895756999999999 * fTemp44) + ((0.014027317900000001 * fTemp40) + (((((1.4249399999999999e-05 * fTemp41) + (8.8949000000000002e-06 * fTemp37)) + (2.5334000000000002e-06 * fTemp38)) + (0.13490089590000001 * fTemp42)) + (0.0025979815999999998 * fTemp43)))) - ((9.53405e-05 * fTemp36) + (0.0021019875999999998 * fTemp39))));
			...
			double fTemp431 = (fConst426 * (((((5.0678e-06 * fTemp56) + (8.4515000000000003e-06 * fTemp51)) + (0.1373739266 * fTemp52)) + (0.0134262867 * fTemp58)) - ((0.00050122809999999997 * fTemp54) + ((0.0006530695 * fTemp57) + (((5.5442999999999998e-05 * fTemp50) + (8.6745999999999999e-06 * fTemp55)) + (0.00048833769999999995 * fTemp53))))));
			...
			double fTemp435 = (fConst432 * ((((2.8644000000000001e-06 * fTemp67) + (0.15323652099999999 * fTemp64)) + (0.0023081566000000002 * fTemp68)) - (((3.0661599999999998e-05 * fTemp63) + (9.4235000000000005e-06 * fTemp66)) + (0.0044546585 * fTemp65))));
			...
			double fTemp438 = (fConst436 * ((0.1357607354 * fTemp74) - ((1.1762e-05 * fTemp72) + (0.0033598621 * fTemp73))));
			double fTemp439 = (fConst437 * fRec934[1]);
			fRec936[0] = (fTemp438 + (fRec936[1] + fTemp439));
			fRec934[0] = fRec936[0];
			double fRec935 = (fTemp439 + fTemp438);
			double fTemp440 = (fConst439 * ((((0.1586708396 * fTemp80) + (0.00045887499999999997 * fTemp81)) + (0.0010117309000000001 * fTemp78)) - ((1.6967099999999999e-05 * fTemp77) + (7.9416000000000003e-06 * fTemp79))));
			...
			fVec12[(IOTA & 1023)] = (((0.0020092845999999998 * fTemp89) + ((0.1487374387 * fTemp9) + ((7.1703200000000002e-05 * fTemp86) + (((fRec881 + (fRec899 + (fRec914 + (fRec926 + (fRec935 + fRec938))))) + (0.1059609017 * fTemp12)) + (9.6419e-06 * fTemp11))))) - ((0.003069067 * fTemp91) + ((0.0013543094000000001 * fTemp7) + ((0.0105624584 * fTemp90) + (((5.8733000000000002e-06 * fTemp88) + (((0.0001680308 * fTemp85) + (7.0555999999999998e-06 * fTemp10)) + (5.716e-06 * fTemp87))) + (0.0018656927 * fTemp8))))));
			output13[i] = FAUSTFLOAT((0.47393364928909959 * (fVec12[((IOTA - iConst442) & 1023)] * fRec0[0])));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
