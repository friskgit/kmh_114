...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "KMH114_AEC_7h7v_full_4");
		m->declare("license", "BSD 3-Clause License");
		m->declare("name", "KMH114_AEC_7h7v_full_4");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst124 = ((((49336.226131375268 / fConst2) + 435.25345285706908) / fConst2) + 1.0);
		fConst125 = (0.0 - (197344.90452550107 / (fConst3 * fConst124)));
		fConst126 = (0.0 - (((197344.90452550107 / fConst2) + 870.50690571413816) / (fConst2 * fConst124)));
		fConst127 = ((((54720.092222982748 / fConst2) + 382.731263871191) / fConst2) + 1.0);
		fConst128 = (0.0 - (218880.36889193099 / (fConst3 * fConst127)));
		fConst129 = (0.0 - (((218880.36889193099 / fConst2) + 765.46252774238201) / (fConst2 * fConst127)));
		fConst130 = ((((69575.706832950033 / fConst2) + 257.76260809770031) / fConst2) + 1.0);
		fConst131 = (1.0 / ((fConst124 * fConst127) * fConst130));
		fConst132 = (0.0 - (278302.82733180013 / (fConst3 * fConst130)));
		fConst133 = (0.0 - (((278302.82733180013 / fConst2) + 515.52521619540062) / (fConst2 * fConst130)));
		fConst134 = ((186.80806134597717 / fConst2) + 1.0);
		fConst135 = (0.0 - (373.61612269195433 / (fConst2 * fConst134)));
		fConst136 = ((((37452.552265629485 / fConst2) + 343.41505993548714) / fConst2) + 1.0);
		fConst137 = (0.0 - (149810.20906251794 / (fConst3 * fConst136)));
		fConst138 = (0.0 - (((149810.20906251794 / fConst2) + 686.83011987097427) / (fConst2 * fConst136)));
		fConst139 = ((((47644.160214170784 / fConst2) + 238.16782502279173) / fConst2) + 1.0);
		fConst140 = (1.0 / ((fConst134 * fConst136) * fConst139));
		fConst141 = (0.0 - (190576.64085668314 / (fConst3 * fConst139)));
		fConst142 = (0.0 - (((190576.64085668314 / fConst2) + 476.33565004558346) / (fConst2 * fConst139)));
		fConst143 = ((118.95641347566826 / fConst2) + 1.0);
		fConst144 = (0.0 - (237.91282695133651 / (fConst2 * fConst143)));
		fConst145 = ((((16950.258950005893 / fConst2) + 188.39996504603437) / fConst2) + 1.0);
		fConst146 = (1.0 / (fConst143 * fConst145));
		fConst147 = (0.0 - (67801.035800023572 / (fConst3 * fConst145)));
		fConst148 = (0.0 - (((67801.035800023572 / fConst2) + 376.79993009206873) / (fConst2 * fConst145)));
		fConst149 = ((((7872.3286181646799 / fConst2) + 153.67818926085133) / fConst2) + 1.0);
		fConst150 = (1.0 / fConst149);
		fConst151 = (0.0 - (31489.31447265872 / (fConst3 * fConst149)));
		fConst152 = (0.0 - (((31489.31447265872 / fConst2) + 307.35637852170265) / (fConst2 * fConst149)));
		fConst153 = ((((23984.704660435331 / fConst2) + 296.72293410634251) / fConst2) + 1.0);
		fConst154 = (0.0 - (95938.818641741324 / (fConst3 * fConst153)));
		fConst155 = (0.0 - (((95938.818641741324 / fConst2) + 593.44586821268501) / (fConst2 * fConst153)));
		fConst156 = ((((30145.246817946248 / fConst2) + 215.53769676316182) / fConst2) + 1.0);
		fConst157 = (1.0 / (fConst153 * fConst156));
		fConst158 = (0.0 - (120580.98727178499 / (fConst3 * fConst156)));
		fConst159 = (0.0 - (((120580.98727178499 / fConst2) + 431.07539352632364) / (fConst2 * fConst156)));
		...
		fConst395 = ((56.264692243043932 / fConst2) + 1.0);
		fConst396 = (1.0 / fConst395);
		fConst397 = (0.0 - (112.52938448608786 / (fConst2 * fConst395)));
		fConst398 = ((((9497.1467796133438 / fConst2) + 168.7940767291318) / fConst2) + 1.0);
		fConst399 = (1.0 / fConst398);
		fConst400 = (0.0 - (37988.587118453375 / (fConst3 * fConst398)));
		fConst401 = (0.0 - (((37988.587118453375 / fConst2) + 337.5881534582636) / (fConst2 * fConst398)));
	...
	virtual void instanceClear() {
		...
		for (int l232 = 0; (l232 < 16); l232 = (l232 + 1)) {
			fVec3[l232] = 0.0;
		...
		for (int l275 = 0; (l275 < 64); l275 = (l275 + 1)) {
			fVec4[l275] = 0.0;
		...
		for (int l318 = 0; (l318 < 8); l318 = (l318 + 1)) {
			fVec5[l318] = 0.0;
		...
		for (int l403 = 0; (l403 < 128); l403 = (l403 + 1)) {
			fVec6[l403] = 0.0;
		...
		for (int l446 = 0; (l446 < 64); l446 = (l446 + 1)) {
			fVec7[l446] = 0.0;
		...
		for (int l618 = 0; (l618 < 256); l618 = (l618 + 1)) {
			fVec11[l618] = 0.0;
		...
		for (int l661 = 0; (l661 < 1024); l661 = (l661 + 1)) {
			fVec12[l661] = 0.0;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("KMH114_AEC_7h7v_full_4");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp7 = (((fTemp1 * (fRec2[2] + (fRec2[0] + (2.0 * fRec2[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec2[1]) + ((fRec2[0] + fRec2[2]) / fTemp4))))));
			fRec4[0] = (double(input56[i]) - (((fTemp2 * fRec4[2]) + (2.0 * (fTemp3 * fRec4[1]))) / fTemp4));
			double fTemp8 = (((fTemp1 * (fRec4[2] + (fRec4[0] + (2.0 * fRec4[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec4[1]) + ((fRec4[0] + fRec4[2]) / fTemp4))))));
			fRec5[0] = (double(input53[i]) - (((fTemp2 * fRec5[2]) + (2.0 * (fTemp3 * fRec5[1]))) / fTemp4));
			double fTemp9 = (((fTemp1 * (fRec5[2] + (fRec5[0] + (2.0 * fRec5[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec5[1]) + ((fRec5[0] + fRec5[2]) / fTemp4))))));
			fRec6[0] = (double(input50[i]) - (((fTemp2 * fRec6[2]) + (2.0 * (fTemp3 * fRec6[1]))) / fTemp4));
			double fTemp10 = (((fTemp1 * (fRec6[2] + (fRec6[0] + (2.0 * fRec6[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec6[1]) + ((fRec6[0] + fRec6[2]) / fTemp4))))));
			fRec7[0] = (double(input0[i]) - (((fRec7[2] * fTemp2) + (2.0 * (fRec7[1] * fTemp3))) / fTemp4));
			double fTemp11 = (((fTemp1 * (fRec7[2] + (fRec7[0] + (2.0 * fRec7[1])))) / fTemp5) + (0.84178367409999999 * (fRec3[0] * (0.0 - ((fRec7[1] * fTemp6) + ((fRec7[0] + fRec7[2]) / fTemp4))))));
			...
			double fTemp16 = (((fTemp1 * (fRec26[2] + (fRec26[0] + (2.0 * fRec26[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec26[1]) + ((fRec26[0] + fRec26[2]) / fTemp4))))));
			fRec27[0] = (double(input37[i]) - (((fTemp2 * fRec27[2]) + (2.0 * (fTemp3 * fRec27[1]))) / fTemp4));
			double fTemp17 = (((fTemp1 * (fRec27[2] + (fRec27[0] + (2.0 * fRec27[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec27[1]) + ((fRec27[0] + fRec27[2]) / fTemp4))))));
			fRec28[0] = (double(input39[i]) - (((fTemp2 * fRec28[2]) + (2.0 * (fTemp3 * fRec28[1]))) / fTemp4));
			double fTemp18 = (((fTemp1 * (fRec28[2] + (fRec28[0] + (2.0 * fRec28[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec28[1]) + ((fRec28[0] + fRec28[2]) / fTemp4))))));
			fRec29[0] = (double(input40[i]) - (((fTemp2 * fRec29[2]) + (2.0 * (fTemp3 * fRec29[1]))) / fTemp4));
			double fTemp19 = (((fTemp1 * (fRec29[2] + (fRec29[0] + (2.0 * fRec29[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec29[1]) + ((fRec29[0] + fRec29[2]) / fTemp4))))));
			fRec30[0] = (double(input44[i]) - (((fTemp2 * fRec30[2]) + (2.0 * (fTemp3 * fRec30[1]))) / fTemp4));
			double fTemp20 = (((fTemp1 * (fRec30[2] + (fRec30[0] + (2.0 * fRec30[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec30[1]) + ((fRec30[0] + fRec30[2]) / fTemp4))))));
			fRec31[0] = (double(input46[i]) - (((fTemp2 * fRec31[2]) + (2.0 * (fTemp3 * fRec31[1]))) / fTemp4));
			double fTemp21 = (((fTemp1 * (fRec31[2] + (fRec31[0] + (2.0 * fRec31[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec31[1]) + ((fRec31[0] + fRec31[2]) / fTemp4))))));
			fRec32[0] = (double(input47[i]) - (((fTemp2 * fRec32[2]) + (2.0 * (fTemp3 * fRec32[1]))) / fTemp4));
			double fTemp22 = (((fTemp1 * (fRec32[2] + (fRec32[0] + (2.0 * fRec32[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec32[1]) + ((fRec32[0] + fRec32[2]) / fTemp4))))));
			fRec33[0] = (double(input38[i]) - (((fTemp2 * fRec33[2]) + (2.0 * (fTemp3 * fRec33[1]))) / fTemp4));
			double fTemp23 = (((fTemp1 * (fRec33[2] + (fRec33[0] + (2.0 * fRec33[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec33[1]) + ((fRec33[0] + fRec33[2]) / fTemp4))))));
			fRec34[0] = (double(input41[i]) - (((fTemp2 * fRec34[2]) + (2.0 * (fTemp3 * fRec34[1]))) / fTemp4));
			double fTemp24 = (((fTemp1 * (fRec34[2] + (fRec34[0] + (2.0 * fRec34[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec34[1]) + ((fRec34[0] + fRec34[2]) / fTemp4))))));
			fRec35[0] = (double(input42[i]) - (((fTemp2 * fRec35[2]) + (2.0 * (fTemp3 * fRec35[1]))) / fTemp4));
			double fTemp25 = (((fTemp1 * (fRec35[2] + (fRec35[0] + (2.0 * fRec35[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec35[1]) + ((fRec35[0] + fRec35[2]) / fTemp4))))));
			fRec36[0] = (double(input43[i]) - (((fTemp2 * fRec36[2]) + (2.0 * (fTemp3 * fRec36[1]))) / fTemp4));
			double fTemp26 = (((fTemp1 * (fRec36[2] + (fRec36[0] + (2.0 * fRec36[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec36[1]) + ((fRec36[0] + fRec36[2]) / fTemp4))))));
			fRec37[0] = (double(input45[i]) - (((fTemp2 * fRec37[2]) + (2.0 * (fTemp3 * fRec37[1]))) / fTemp4));
			double fTemp27 = (((fTemp1 * (fRec37[2] + (fRec37[0] + (2.0 * fRec37[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec37[1]) + ((fRec37[0] + fRec37[2]) / fTemp4))))));
			fRec38[0] = (double(input48[i]) - (((fTemp2 * fRec38[2]) + (2.0 * (fTemp3 * fRec38[1]))) / fTemp4));
			double fTemp28 = (((fTemp1 * (fRec38[2] + (fRec38[0] + (2.0 * fRec38[1])))) / fTemp5) + (0.2685223665 * (fRec3[0] * (0.0 - ((fTemp6 * fRec38[1]) + ((fRec38[0] + fRec38[2]) / fTemp4))))));
			double fTemp29 = (fConst11 * ((((((((0.067525623699999995 * fTemp16) + (0.0087852157999999993 * fTemp17)) + (0.0073707533000000004 * fTemp18)) + (0.055360489499999999 * fTemp19)) + (0.025490790900000001 * fTemp20)) + (0.026764049500000001 * fTemp21)) + (0.012900036599999999 * fTemp22)) - ((((((0.077977335999999994 * fTemp23) + (0.0064401010000000002 * fTemp24)) + (0.0452295422 * fTemp25)) + (0.0094565165999999992 * fTemp26)) + (0.0108230679 * fTemp27)) + (0.1177451929 * fTemp28))));
			...
			double fTemp35 = (((fTemp1 * (fRec54[2] + (fRec54[0] + (2.0 * fRec54[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec54[1]) + ((fRec54[0] + fRec54[2]) / fTemp4))))));
			fRec55[0] = (double(input28[i]) - (((fTemp2 * fRec55[2]) + (2.0 * (fTemp3 * fRec55[1]))) / fTemp4));
			double fTemp36 = (((fTemp1 * (fRec55[2] + (fRec55[0] + (2.0 * fRec55[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec55[1]) + ((fRec55[0] + fRec55[2]) / fTemp4))))));
			fRec56[0] = (double(input29[i]) - (((fTemp2 * fRec56[2]) + (2.0 * (fTemp3 * fRec56[1]))) / fTemp4));
			double fTemp37 = (((fTemp1 * (fRec56[2] + (fRec56[0] + (2.0 * fRec56[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec56[1]) + ((fRec56[0] + fRec56[2]) / fTemp4))))));
			fRec57[0] = (double(input31[i]) - (((fTemp2 * fRec57[2]) + (2.0 * (fTemp3 * fRec57[1]))) / fTemp4));
			double fTemp38 = (((fTemp1 * (fRec57[2] + (fRec57[0] + (2.0 * fRec57[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec57[1]) + ((fRec57[0] + fRec57[2]) / fTemp4))))));
			fRec58[0] = (double(input33[i]) - (((fTemp2 * fRec58[2]) + (2.0 * (fTemp3 * fRec58[1]))) / fTemp4));
			double fTemp39 = (((fTemp1 * (fRec58[2] + (fRec58[0] + (2.0 * fRec58[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec58[1]) + ((fRec58[0] + fRec58[2]) / fTemp4))))));
			fRec59[0] = (double(input34[i]) - (((fTemp2 * fRec59[2]) + (2.0 * (fTemp3 * fRec59[1]))) / fTemp4));
			double fTemp40 = (((fTemp1 * (fRec59[2] + (fRec59[0] + (2.0 * fRec59[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec59[1]) + ((fRec59[0] + fRec59[2]) / fTemp4))))));
			fRec60[0] = (double(input27[i]) - (((fTemp2 * fRec60[2]) + (2.0 * (fTemp3 * fRec60[1]))) / fTemp4));
			double fTemp41 = (((fTemp1 * (fRec60[2] + (fRec60[0] + (2.0 * fRec60[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec60[1]) + ((fRec60[0] + fRec60[2]) / fTemp4))))));
			fRec61[0] = (double(input30[i]) - (((fTemp2 * fRec61[2]) + (2.0 * (fTemp3 * fRec61[1]))) / fTemp4));
			double fTemp42 = (((fTemp1 * (fRec61[2] + (fRec61[0] + (2.0 * fRec61[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec61[1]) + ((fRec61[0] + fRec61[2]) / fTemp4))))));
			fRec62[0] = (double(input35[i]) - (((fTemp2 * fRec62[2]) + (2.0 * (fTemp3 * fRec62[1]))) / fTemp4));
			double fTemp43 = (((fTemp1 * (fRec62[2] + (fRec62[0] + (2.0 * fRec62[1])))) / fTemp5) + (0.40645413679999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec62[1]) + ((fRec62[0] + fRec62[2]) / fTemp4))))));
			double fTemp44 = (fConst20 * (((((((0.1034674904 * fTemp35) + (0.010396038200000001 * fTemp36)) + (0.029910968699999999 * fTemp37)) + (0.055802496799999997 * fTemp38)) + (0.0024325935 * fTemp39)) + (0.028088375499999998 * fTemp40)) - (((0.077539064399999996 * fTemp41) + (0.018155399999999999 * fTemp42)) + (0.082841172599999999 * fTemp43))));
			double fTemp45 = (fConst21 * fRec48[1]);
			double fTemp46 = (fConst22 * fRec51[1]);
			fRec53[0] = (fTemp44 + (fTemp45 + (fRec53[1] + fTemp46)));
			fRec51[0] = fRec53[0];
			double fRec52 = ((fTemp46 + fTemp45) + fTemp44);
			...
			double fTemp47 = (fConst24 * fRec63[1]);
			double fTemp48 = (fConst25 * fRec66[1]);
			fRec75[0] = (double(input16[i]) - (((fTemp2 * fRec75[2]) + (2.0 * (fTemp3 * fRec75[1]))) / fTemp4));
			double fTemp49 = (((fTemp1 * (fRec75[2] + (fRec75[0] + (2.0 * fRec75[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec75[1]) + ((fRec75[0] + fRec75[2]) / fTemp4))))));
			fRec76[0] = (double(input19[i]) - (((fTemp2 * fRec76[2]) + (2.0 * (fTemp3 * fRec76[1]))) / fTemp4));
			double fTemp50 = (((fTemp1 * (fRec76[2] + (fRec76[0] + (2.0 * fRec76[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec76[1]) + ((fRec76[0] + fRec76[2]) / fTemp4))))));
			fRec77[0] = (double(input20[i]) - (((fTemp2 * fRec77[2]) + (2.0 * (fTemp3 * fRec77[1]))) / fTemp4));
			double fTemp51 = (((fTemp1 * (fRec77[2] + (fRec77[0] + (2.0 * fRec77[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec77[1]) + ((fRec77[0] + fRec77[2]) / fTemp4))))));
			fRec78[0] = (double(input21[i]) - (((fTemp2 * fRec78[2]) + (2.0 * (fTemp3 * fRec78[1]))) / fTemp4));
			double fTemp52 = (((fTemp1 * (fRec78[2] + (fRec78[0] + (2.0 * fRec78[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec78[1]) + ((fRec78[0] + fRec78[2]) / fTemp4))))));
			fRec79[0] = (double(input23[i]) - (((fTemp2 * fRec79[2]) + (2.0 * (fTemp3 * fRec79[1]))) / fTemp4));
			double fTemp53 = (((fTemp1 * (fRec79[2] + (fRec79[0] + (2.0 * fRec79[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec79[1]) + ((fRec79[0] + fRec79[2]) / fTemp4))))));
			fRec80[0] = (double(input17[i]) - (((fTemp2 * fRec80[2]) + (2.0 * (fTemp3 * fRec80[1]))) / fTemp4));
			double fTemp54 = (((fTemp1 * (fRec80[2] + (fRec80[0] + (2.0 * fRec80[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec80[1]) + ((fRec80[0] + fRec80[2]) / fTemp4))))));
			fRec81[0] = (double(input18[i]) - (((fTemp2 * fRec81[2]) + (2.0 * (fTemp3 * fRec81[1]))) / fTemp4));
			double fTemp55 = (((fTemp1 * (fRec81[2] + (fRec81[0] + (2.0 * fRec81[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec81[1]) + ((fRec81[0] + fRec81[2]) / fTemp4))))));
			fRec82[0] = (double(input22[i]) - (((fTemp2 * fRec82[2]) + (2.0 * (fTemp3 * fRec82[1]))) / fTemp4));
			double fTemp56 = (((fTemp1 * (fRec82[2] + (fRec82[0] + (2.0 * fRec82[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec82[1]) + ((fRec82[0] + fRec82[2]) / fTemp4))))));
			fRec83[0] = (double(input24[i]) - (((fTemp2 * fRec83[2]) + (2.0 * (fTemp3 * fRec83[1]))) / fTemp4));
			double fTemp57 = (((fTemp1 * (fRec83[2] + (fRec83[0] + (2.0 * fRec83[1])))) / fTemp5) + (0.53646348659999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec83[1]) + ((fRec83[0] + fRec83[2]) / fTemp4))))));
			double fTemp58 = (fConst27 * ((((((0.1162417493 * fTemp49) + (0.0085065214999999993 * fTemp50)) + (0.040475713900000002 * fTemp51)) + (0.012490807499999999 * fTemp52)) + (0.0128205214 * fTemp53)) - ((((0.0087310640999999998 * fTemp54) + (0.0606270712 * fTemp55)) + (0.0314665155 * fTemp56)) + (0.0080716095999999998 * fTemp57))));
			double fTemp59 = (fConst28 * fRec69[1]);
			double fTemp60 = (fConst29 * fRec72[1]);
			fRec74[0] = (fTemp58 + (fTemp59 + (fRec74[1] + fTemp60)));
			fRec72[0] = fRec74[0];
			double fRec73 = ((fTemp60 + fTemp59) + fTemp58);
			fRec71[0] = (fRec72[0] + fRec71[1]);
			fRec69[0] = fRec71[0];
			double fRec70 = fRec73;
			fRec68[0] = (fTemp47 + (fTemp48 + (fRec70 + fRec68[1])));
			fRec66[0] = fRec68[0];
			double fRec67 = (fTemp47 + (fRec70 + fTemp48));
			fRec65[0] = (fRec66[0] + fRec65[1]);
			fRec63[0] = fRec65[0];
			double fRec64 = fRec67;
			double fTemp61 = (fConst31 * fRec84[1]);
			fRec93[0] = (double(input9[i]) - (((fTemp2 * fRec93[2]) + (2.0 * (fTemp3 * fRec93[1]))) / fTemp4));
			double fTemp62 = (((fTemp1 * (fRec93[2] + (fRec93[0] + (2.0 * fRec93[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec93[1]) + ((fRec93[0] + fRec93[2]) / fTemp4))))));
			fRec94[0] = (double(input12[i]) - (((fTemp2 * fRec94[2]) + (2.0 * (fTemp3 * fRec94[1]))) / fTemp4));
			double fTemp63 = (((fTemp1 * (fRec94[2] + (fRec94[0] + (2.0 * fRec94[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec94[1]) + ((fRec94[0] + fRec94[2]) / fTemp4))))));
			fRec95[0] = (double(input15[i]) - (((fTemp2 * fRec95[2]) + (2.0 * (fTemp3 * fRec95[1]))) / fTemp4));
			double fTemp64 = (((fTemp1 * (fRec95[2] + (fRec95[0] + (2.0 * fRec95[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec95[1]) + ((fRec95[0] + fRec95[2]) / fTemp4))))));
			fRec96[0] = (double(input10[i]) - (((fTemp2 * fRec96[2]) + (2.0 * (fTemp3 * fRec96[1]))) / fTemp4));
			double fTemp65 = (((fTemp1 * (fRec96[2] + (fRec96[0] + (2.0 * fRec96[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec96[1]) + ((fRec96[0] + fRec96[2]) / fTemp4))))));
			fRec97[0] = (double(input11[i]) - (((fTemp2 * fRec97[2]) + (2.0 * (fTemp3 * fRec97[1]))) / fTemp4));
			double fTemp66 = (((fTemp1 * (fRec97[2] + (fRec97[0] + (2.0 * fRec97[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec97[1]) + ((fRec97[0] + fRec97[2]) / fTemp4))))));
			fRec98[0] = (double(input13[i]) - (((fTemp2 * fRec98[2]) + (2.0 * (fTemp3 * fRec98[1]))) / fTemp4));
			double fTemp67 = (((fTemp1 * (fRec98[2] + (fRec98[0] + (2.0 * fRec98[1])))) / fTemp5) + (0.65104332919999996 * (fRec3[0] * (0.0 - ((fTemp6 * fRec98[1]) + ((fRec98[0] + fRec98[2]) / fTemp4))))));
			double fTemp68 = (fConst33 * ((((0.1080501526 * fTemp62) + (0.018559952599999999 * fTemp63)) + (0.0097989015999999998 * fTemp64)) - (((0.0110138549 * fTemp65) + (0.031726261999999998 * fTemp66)) + (0.061615664000000001 * fTemp67))));
			double fTemp69 = (fConst34 * fRec87[1]);
			double fTemp70 = (fConst35 * fRec90[1]);
			fRec92[0] = (fTemp68 + (fTemp69 + (fRec92[1] + fTemp70)));
			fRec90[0] = fRec92[0];
			double fRec91 = ((fTemp70 + fTemp69) + fTemp68);
			fRec89[0] = (fRec90[0] + fRec89[1]);
			fRec87[0] = fRec89[0];
			double fRec88 = fRec91;
			fRec86[0] = (fTemp61 + (fRec88 + fRec86[1]));
			fRec84[0] = fRec86[0];
			double fRec85 = (fRec88 + fTemp61);
			fRec102[0] = (double(input1[i]) - (((fTemp2 * fRec102[2]) + (2.0 * (fTemp3 * fRec102[1]))) / fTemp4));
			double fTemp71 = (((fTemp1 * (fRec102[2] + (fRec102[0] + (2.0 * fRec102[1])))) / fTemp5) + (0.80835632359999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec102[1]) + ((fRec102[0] + fRec102[2]) / fTemp4))))));
			fRec103[0] = (double(input3[i]) - (((fTemp2 * fRec103[2]) + (2.0 * (fTemp3 * fRec103[1]))) / fTemp4));
			double fTemp72 = (((fTemp1 * (fRec103[2] + (fRec103[0] + (2.0 * fRec103[1])))) / fTemp5) + (0.80835632359999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec103[1]) + ((fRec103[0] + fRec103[2]) / fTemp4))))));
			fRec104[0] = (double(input2[i]) - (((fTemp2 * fRec104[2]) + (2.0 * (fTemp3 * fRec104[1]))) / fTemp4));
			double fTemp73 = (((fTemp1 * (fRec104[2] + (fRec104[0] + (2.0 * fRec104[1])))) / fTemp5) + (0.80835632359999998 * (fRec3[0] * (0.0 - ((fTemp6 * fRec104[1]) + ((fRec104[0] + fRec104[2]) / fTemp4))))));
			double fTemp74 = (fConst37 * (((0.044678303599999997 * fTemp71) + (0.090147724400000004 * fTemp72)) - (0.0164336528 * fTemp73)));
			double fTemp75 = (fConst38 * fRec99[1]);
			fRec101[0] = (fTemp74 + (fRec101[1] + fTemp75));
			fRec99[0] = fRec101[0];
			double fRec100 = (fTemp75 + fTemp74);
			fRec111[0] = (double(input4[i]) - (((fTemp2 * fRec111[2]) + (2.0 * (fTemp3 * fRec111[1]))) / fTemp4));
			double fTemp76 = (((fTemp1 * (fRec111[2] + (fRec111[0] + (2.0 * fRec111[1])))) / fTemp5) + (0.74349273000000005 * (fRec3[0] * (0.0 - ((fTemp6 * fRec111[1]) + ((fRec111[0] + fRec111[2]) / fTemp4))))));
			fRec112[0] = (double(input8[i]) - (((fTemp2 * fRec112[2]) + (2.0 * (fTemp3 * fRec112[1]))) / fTemp4));
			double fTemp77 = (((fTemp1 * (fRec112[2] + (fRec112[0] + (2.0 * fRec112[1])))) / fTemp5) + (0.74349273000000005 * (fRec3[0] * (0.0 - ((fTemp6 * fRec112[1]) + ((fRec112[0] + fRec112[2]) / fTemp4))))));
			fRec113[0] = (double(input5[i]) - (((fTemp2 * fRec113[2]) + (2.0 * (fTemp3 * fRec113[1]))) / fTemp4));
			double fTemp78 = (((fTemp1 * (fRec113[2] + (fRec113[0] + (2.0 * fRec113[1])))) / fTemp5) + (0.74349273000000005 * (fRec3[0] * (0.0 - ((fTemp6 * fRec113[1]) + ((fRec113[0] + fRec113[2]) / fTemp4))))));
			fRec114[0] = (double(input6[i]) - (((fTemp2 * fRec114[2]) + (2.0 * (fTemp3 * fRec114[1]))) / fTemp4));
			double fTemp79 = (((fTemp1 * (fRec114[2] + (fRec114[0] + (2.0 * fRec114[1])))) / fTemp5) + (0.74349273000000005 * (fRec3[0] * (0.0 - ((fTemp6 * fRec114[1]) + ((fRec114[0] + fRec114[2]) / fTemp4))))));
			fRec115[0] = (double(input7[i]) - (((fTemp2 * fRec115[2]) + (2.0 * (fTemp3 * fRec115[1]))) / fTemp4));
			double fTemp80 = (((fTemp1 * (fRec115[2] + (fRec115[0] + (2.0 * fRec115[1])))) / fTemp5) + (0.74349273000000005 * (fRec3[0] * (0.0 - ((fTemp6 * fRec115[1]) + ((fRec115[0] + fRec115[2]) / fTemp4))))));
			double fTemp81 = (fConst40 * (((0.083268513700000005 * fTemp76) + (0.048747716199999999 * fTemp77)) - (((0.0079933001999999993 * fTemp78) + (0.042130477800000003 * fTemp79)) + (0.0117372035 * fTemp80))));
			double fTemp82 = (fConst41 * fRec105[1]);
			double fTemp83 = (fConst42 * fRec108[1]);
			fRec110[0] = (fTemp81 + (fTemp82 + (fRec110[1] + fTemp83)));
			fRec108[0] = fRec110[0];
			double fRec109 = ((fTemp83 + fTemp82) + fTemp81);
			fRec107[0] = (fRec108[0] + fRec107[1]);
			fRec105[0] = fRec107[0];
			double fRec106 = fRec109;
			fRec116[0] = (double(input49[i]) - (((fTemp2 * fRec116[2]) + (2.0 * (fTemp3 * fRec116[1]))) / fTemp4));
			double fTemp84 = (((fTemp1 * (fRec116[2] + (fRec116[0] + (2.0 * fRec116[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec116[1]) + ((fRec116[0] + fRec116[2]) / fTemp4))))));
			fRec117[0] = (double(input51[i]) - (((fTemp2 * fRec117[2]) + (2.0 * (fTemp3 * fRec117[1]))) / fTemp4));
			double fTemp85 = (((fTemp1 * (fRec117[2] + (fRec117[0] + (2.0 * fRec117[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec117[1]) + ((fRec117[0] + fRec117[2]) / fTemp4))))));
			fRec118[0] = (double(input54[i]) - (((fTemp2 * fRec118[2]) + (2.0 * (fTemp3 * fRec118[1]))) / fTemp4));
			double fTemp86 = (((fTemp1 * (fRec118[2] + (fRec118[0] + (2.0 * fRec118[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec118[1]) + ((fRec118[0] + fRec118[2]) / fTemp4))))));
			fRec119[0] = (double(input55[i]) - (((fTemp2 * fRec119[2]) + (2.0 * (fTemp3 * fRec119[1]))) / fTemp4));
			double fTemp87 = (((fTemp1 * (fRec119[2] + (fRec119[0] + (2.0 * fRec119[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec119[1]) + ((fRec119[0] + fRec119[2]) / fTemp4))))));
			fRec120[0] = (double(input57[i]) - (((fTemp2 * fRec120[2]) + (2.0 * (fTemp3 * fRec120[1]))) / fTemp4));
			double fTemp88 = (((fTemp1 * (fRec120[2] + (fRec120[0] + (2.0 * fRec120[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec120[1]) + ((fRec120[0] + fRec120[2]) / fTemp4))))));
			fRec121[0] = (double(input59[i]) - (((fTemp2 * fRec121[2]) + (2.0 * (fTemp3 * fRec121[1]))) / fTemp4));
			double fTemp89 = (((fTemp1 * (fRec121[2] + (fRec121[0] + (2.0 * fRec121[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec121[1]) + ((fRec121[0] + fRec121[2]) / fTemp4))))));
			fRec122[0] = (double(input60[i]) - (((fTemp2 * fRec122[2]) + (2.0 * (fTemp3 * fRec122[1]))) / fTemp4));
			double fTemp90 = (((fTemp1 * (fRec122[2] + (fRec122[0] + (2.0 * fRec122[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec122[1]) + ((fRec122[0] + fRec122[2]) / fTemp4))))));
			fRec123[0] = (double(input63[i]) - (((fTemp2 * fRec123[2]) + (2.0 * (fTemp3 * fRec123[1]))) / fTemp4));
			double fTemp91 = (((fTemp1 * (fRec123[2] + (fRec123[0] + (2.0 * fRec123[1])))) / fTemp5) + (0.13049230589999999 * (fRec3[0] * (0.0 - ((fTemp6 * fRec123[1]) + ((fRec123[0] + fRec123[2]) / fTemp4))))));
			fVec0[(IOTA & 127)] = (((0.066661920999999999 * fTemp7) + ((0.0095509663999999994 * fTemp8) + ((0.068386585299999997 * fTemp9) + ((0.0112691641 * fTemp10) + (((0.067039280199999995 * fTemp11) + (fRec9 + (fRec40 + (fRec64 + (fRec85 + (fRec100 + fRec106)))))) + (0.018340731799999999 * fTemp84)))))) - (((((((0.062843841600000006 * fTemp85) + (0.0066806506999999996 * fTemp86)) + (0.029275553700000002 * fTemp87)) + (0.053133680799999999 * fTemp88)) + (0.0088731585000000005 * fTemp89)) + (0.021150322499999999 * fTemp90)) + (0.1233135835 * fTemp91)));
			...
			double fTemp96 = (fConst51 * ((((0.0031978610999999998 * fTemp27) + ((0.062888032699999999 * fTemp20) + ((((6.0483599999999998e-05 * fTemp17) + (0.0038916261000000001 * fTemp23)) + (5.0745399999999997e-05 * fTemp18)) + (0.0027940901 * fTemp26)))) + (0.13541776329999999 * fTemp28)) - ((0.0038115371999999999 * fTemp22) + (((0.016825554600000001 * fTemp25) + (((0.0062309189000000001 * fTemp16) + (0.0020518123000000002 * fTemp19)) + (4.4338200000000002e-05 * fTemp24))) + (0.086936773300000006 * fTemp21)))));
			...
			double fTemp102 = (fConst60 * ((((0.037812128700000003 * fTemp38) + ((0.0033013943000000001 * fTemp41) + (0.0017362841999999999 * fTemp42))) + (0.14604045860000001 * fTemp43)) - ((0.0082793437000000004 * fTemp40) + ((((0.0063327949 * fTemp35) + (1.8518199999999998e-05 * fTemp36)) + (0.0010400323999999999 * fTemp37)) + (0.084801826999999996 * fTemp39)))));
			...
			double fTemp107 = (fConst67 * (((((0.0025190759999999999 * fTemp55) + (5.8564899999999999e-05 * fTemp50)) + (0.016304819500000001 * fTemp51)) + (0.1202166776 * fTemp57)) - ((0.0037880430000000001 * fTemp53) + ((0.077630672900000003 * fTemp56) + (((0.0058012936000000001 * fTemp49) + (6.0110800000000001e-05 * fTemp54)) + (0.0036906233999999998 * fTemp52))))));
			...
			double fTemp111 = (fConst73 * ((((1.9618699999999999e-05 * fTemp65) + (0.0013576033999999999 * fTemp66)) + (0.1242264077 * fTemp64)) - (((0.0050544261000000004 * fTemp62) + (0.0090859515999999994 * fTemp63)) + (0.050479181999999997 * fTemp67))));
			...
			double fTemp114 = (fConst77 * (((0.0012287811 * fTemp73) + (0.085525769200000004 * fTemp72)) - (0.0022660483000000002 * fTemp71)));
			double fTemp115 = (fConst78 * fRec178[1]);
			fRec180[0] = (fTemp114 + (fRec180[1] + fTemp115));
			fRec178[0] = fRec180[0];
			double fRec179 = (fTemp115 + fTemp114);
			double fTemp116 = (fConst80 * (((0.0034679581999999998 * fTemp80) + (0.12026492129999999 * fTemp77)) - (((0.0038835571000000002 * fTemp76) + (5.5031500000000003e-05 * fTemp78)) + (0.033664372300000002 * fTemp79))));
			...
			fVec1[(IOTA & 63)] = (((0.1273785248 * fTemp91) + ((0.0062342797000000004 * fTemp90) + ((0.071703022699999994 * fTemp89) + ((0.00086238790000000003 * fTemp87) + ((1.19001e-05 * fTemp86) + (((0.061559382400000001 * fTemp11) + (fRec125 + (fRec143 + (fRec158 + (fRec170 + (fRec179 + fRec182)))))) + (0.0043369196999999996 * fTemp85))))))) - (((0.030668138099999999 * fTemp88) + ((((0.0052440487000000001 * fTemp84) + (2.00735e-05 * fTemp10)) + (0.0026801398000000001 * fTemp9)) + (0.0064304582999999997 * fTemp8))) + (0.10199536319999999 * fTemp7)));
			...
			double fTemp123 = (fConst91 * (((0.013676294199999999 * fTemp22) + ((((0.075846776399999996 * fTemp23) + (0.0079634600000000003 * fTemp24)) + (0.025999019700000001 * fTemp20)) + (0.032124861900000003 * fTemp21))) - ((((0.010025560899999999 * fTemp26) + (((((0.052281861800000003 * fTemp16) + (0.010863294500000001 * fTemp17)) + (0.0091142513000000008 * fTemp18)) + (0.057359260799999999 * fTemp19)) + (0.046222533400000002 * fTemp25))) + (0.0114743443 * fTemp27)) + (0.122108851 * fTemp28))));
			...
			double fTemp129 = (fConst100 * (((0.029397234599999999 * fTemp40) + (((0.078178956399999999 * fTemp41) + (0.056620033100000002 * fTemp38)) + (0.0041646968999999997 * fTemp39))) - (((((0.095171715300000001 * fTemp35) + (0.0125087872 * fTemp36)) + (0.031263153500000002 * fTemp37)) + (0.018869364100000001 * fTemp42)) + (0.089036609799999999 * fTemp43))));
			...
			double fTemp134 = (fConst107 * ((((0.0132424398 * fTemp52) + (((0.010796333700000001 * fTemp54) + (0.061527248200000002 * fTemp55)) + (0.041314750999999997 * fTemp51))) + (0.013591994200000001 * fTemp53)) - ((((0.11306569850000001 * fTemp49) + (0.0105186772 * fTemp50)) + (0.032093886699999997 * fTemp56)) + (0.014580018 * fTemp57))));
			...
			double fTemp138 = (fConst113 * (((((0.0132521605 * fTemp65) + (0.031991745500000002 * fTemp66)) + (0.019556846499999999 * fTemp63)) + (0.0079911619 * fTemp64)) - ((0.10684661450000001 * fTemp62) + (0.062110034699999997 * fTemp67))));
			...
			double fTemp141 = (fConst117 * ((0.0903249837 * fTemp72) - ((0.043425176900000001 * fTemp71) + (0.017067387199999999 * fTemp73))));
			double fTemp142 = (fConst118 * fRec241[1]);
			fRec243[0] = (fTemp141 + (fRec243[1] + fTemp142));
			fRec241[0] = fRec243[0];
			double fRec242 = (fTemp142 + fTemp141);
			double fTemp143 = (fConst120 * (((0.0098840570999999995 * fTemp78) + (0.049719635499999998 * fTemp77)) - (((0.082497778199999997 * fTemp76) + (0.042389516600000003 * fTemp79)) + (0.0124434878 * fTemp80))));
			...
			fVec2[(IOTA & 63)] = (((0.071492792299999997 * fTemp7) + ((0.010128060499999999 * fTemp8) + ((0.031313499500000001 * fTemp87) + ((0.0080383350000000006 * fTemp86) + ((0.055523526300000001 * fTemp85) + ((0.0024838208000000001 * fTemp84) + ((0.067150981700000001 * fTemp11) + (fRec188 + (fRec206 + (fRec221 + (fRec233 + (fRec242 + fRec245)))))))))))) - (((0.022135882900000001 * fTemp90) + ((0.0107099033 * fTemp89) + (((0.013559355299999999 * fTemp10) + (0.070019742499999996 * fTemp9)) + (0.054161737799999998 * fTemp88)))) + (0.1215939628 * fTemp91)));
			...
			double fTemp150 = (fConst131 * (((0.093492470199999997 * fTemp28) + ((0.018347872599999999 * fTemp22) + (((0.00096769209999999996 * fTemp16) + (0.0099217274999999997 * fTemp24)) + (0.0535150722 * fTemp21)))) - ((0.0153937759 * fTemp27) + ((0.035930132099999998 * fTemp20) + ((0.013450114000000001 * fTemp26) + (((((0.0135346506 * fTemp17) + (0.071015879099999998 * fTemp23)) + (0.011355506 * fTemp18)) + (0.076908185200000007 * fTemp19)) + (0.054720865899999999 * fTemp25)))))));
			...
			double fTemp156 = (fConst140 * (((0.054698376600000001 * fTemp43) + ((0.037860101799999997 * fTemp40) + (((0.080752282300000006 * fTemp35) + (0.037654963299999997 * fTemp38)) + (0.088676819099999998 * fTemp39)))) - ((((0.0033113104000000002 * fTemp41) + (0.0250188361 * fTemp36)) + (0.058203922399999997 * fTemp37)) + (0.0238084522 * fTemp42))));
			...
			double fTemp160 = (fConst146 * (((((0.019145847899999999 * fTemp62) + (0.026505657700000001 * fTemp65)) + (0.064212000000000005 * fTemp66)) + (0.0256798845 * fTemp63)) - ((0.034872710299999998 * fTemp67) + (0.11489877029999999 * fTemp64))));
			double fTemp161 = (fConst147 * fRec286[1]);
			double fTemp162 = (fConst148 * fRec289[1]);
			fRec291[0] = (fTemp160 + (fTemp161 + (fRec291[1] + fTemp162)));
			fRec289[0] = fRec291[0];
			double fRec290 = ((fTemp162 + fTemp161) + fTemp160);
			fRec288[0] = (fRec289[0] + fRec288[1]);
			fRec286[0] = fRec288[0];
			double fRec287 = fRec290;
			fRec285[0] = (fTemp159 + (fRec287 + fRec285[1]));
			fRec283[0] = fRec285[0];
			double fRec284 = (fRec287 + fTemp159);
			double fTemp163 = (fConst150 * ((0.0123146123 * fTemp78) - ((((0.092685620400000002 * fTemp76) + (0.047195294800000002 * fTemp79)) + (0.016693961600000001 * fTemp80)) + (0.068711554800000005 * fTemp77))));
			double fTemp164 = (fConst151 * fRec292[1]);
			double fTemp165 = (fConst152 * fRec295[1]);
			fRec297[0] = (fTemp163 + (fTemp164 + (fRec297[1] + fTemp165)));
			fRec295[0] = fRec297[0];
			double fRec296 = ((fTemp165 + fTemp164) + fTemp163);
			...
			double fTemp168 = (fConst157 * (((0.0182347772 * fTemp53) + ((0.044353117900000003 * fTemp56) + ((0.017765821300000002 * fTemp52) + ((((0.1058642221 * fTemp49) + (0.013451223700000001 * fTemp54)) + (0.076379468000000006 * fTemp55)) + (0.048523234700000001 * fTemp51))))) - ((0.0131052896 * fTemp50) + (0.036877704999999997 * fTemp57))));
			double fTemp169 = (fConst158 * fRec304[1]);
			double fTemp170 = (fConst159 * fRec307[1]);
			fRec309[0] = (fTemp168 + (fTemp169 + (fRec309[1] + fTemp170)));
			fRec307[0] = fRec309[0];
			double fRec308 = ((fTemp170 + fTemp169) + fTemp168);
			fRec306[0] = (fRec307[0] + fRec306[1]);
			fRec304[0] = fRec306[0];
			double fRec305 = fRec308;
			fRec303[0] = (fTemp166 + (fTemp167 + (fRec305 + fRec303[1])));
			fRec301[0] = fRec303[0];
			double fRec302 = (fTemp166 + (fRec305 + fTemp167));
			fRec300[0] = (fRec301[0] + fRec300[1]);
			fRec298[0] = fRec300[0];
			double fRec299 = fRec302;
			double fTemp171 = (fConst161 * ((0.042054961799999999 * fTemp72) - ((0.093872442799999997 * fTemp71) + (0.021487722599999998 * fTemp73))));
			double fTemp172 = (fConst162 * fRec310[1]);
			fRec312[0] = (fTemp171 + (fRec312[1] + fTemp172));
			fRec310[0] = fRec312[0];
			double fRec311 = (fTemp172 + fTemp171);
			fVec3[0] = (((0.0367115831 * fTemp91) + ((0.013536742399999999 * fTemp8) + ((0.055454034300000003 * fTemp87) + (((0.073166836400000004 * fTemp11) + (fRec251 + (fRec269 + (fRec284 + (fRec293 + (fRec299 + fRec311)))))) + (0.016077480799999998 * fTemp86))))) - ((0.021985504100000001 * fTemp7) + ((0.0285083543 * fTemp90) + ((0.082633235200000002 * fTemp89) + (((((0.0903541187 * fTemp84) + (0.027120078299999999 * fTemp10)) + (0.065768126600000004 * fTemp85)) + (0.0044922529999999999 * fTemp9)) + (0.039952905099999998 * fTemp88))))));
			output3[i] = FAUSTFLOAT((0.99229857819905221 * (fRec0[0] * fVec3[iConst163])));
			double fTemp173 = (fConst45 * fRec313[1]);
			double fTemp174 = (fConst46 * fRec316[1]);
			double fTemp175 = (fConst48 * fRec319[1]);
			double fTemp176 = (fConst49 * fRec322[1]);
			double fTemp177 = (fConst51 * (((((((0.12800473330000001 * fTemp16) + (0.0019370278999999999 * fTemp17)) + (0.0609930344 * fTemp23)) + (0.0016251569999999999 * fTemp18)) + (0.011160959200000001 * fTemp19)) + (0.0088916548000000008 * fTemp22)) - (((0.050018220199999998 * fTemp21) + ((0.0074600550999999998 * fTemp27) + ((0.053712910199999998 * fTemp20) + ((0.0065181273 * fTemp26) + ((0.0014199601000000001 * fTemp24) + (0.034630509099999998 * fTemp25)))))) + (0.020607405299999999 * fTemp28))));
			double fTemp178 = (fConst52 * fRec325[1]);
			double fTemp179 = (fConst53 * fRec328[1]);
			...
			double fTemp180 = (fConst55 * fRec331[1]);
			double fTemp181 = (fConst57 * fRec334[1]);
			double fTemp182 = (fConst58 * fRec337[1]);
			double fTemp183 = (fConst60 * ((0.0082990891000000004 * fTemp40) - ((((((((0.054705119099999998 * fTemp35) + (0.070877603999999997 * fTemp41)) + (0.011980737 * fTemp36)) + (0.053229536199999997 * fTemp37)) + (0.0081536075 * fTemp42)) + (0.0064843273000000003 * fTemp38)) + (0.0352934632 * fTemp39)) + (0.113752406 * fTemp43))));
			double fTemp184 = (fConst61 * fRec340[1]);
			double fTemp185 = (fConst62 * fRec343[1]);
			...
			double fTemp186 = (fConst64 * fRec346[1]);
			double fTemp187 = (fConst65 * fRec349[1]);
			double fTemp188 = (fConst67 * (((0.083966145300000003 * fTemp57) + ((0.0088368470000000001 * fTemp53) + ((0.066304655899999995 * fTemp56) + ((0.008609584 * fTemp52) + ((0.0018755794 * fTemp50) + (0.0313427228 * fTemp51)))))) - (((0.090923047399999998 * fTemp49) + (0.0019250882 * fTemp54)) + (0.0226642593 * fTemp55))));
			double fTemp189 = (fConst68 * fRec352[1]);
			double fTemp190 = (fConst69 * fRec355[1]);
			...
			double fTemp191 = (fConst71 * fRec358[1]);
			double fTemp192 = (fConst73 * ((((((0.10513325649999999 * fTemp62) + (0.012692729200000001 * fTemp65)) + (0.068677465199999996 * fTemp66)) + (0.0026944382 * fTemp63)) + (0.014384558699999999 * fTemp67)) + (0.0626477914 * fTemp64)));
			double fTemp193 = (fConst74 * fRec361[1]);
			double fTemp194 = (fConst75 * fRec364[1]);
			...
			double fTemp195 = (fConst77 * (0.0 - (((0.11372200759999999 * fTemp71) + (0.0076448940999999998 * fTemp73)) + (0.030706741799999999 * fTemp72))));
			double fTemp196 = (fConst78 * fRec367[1]);
			fRec369[0] = (fTemp195 + (fRec369[1] + fTemp196));
			fRec367[0] = fRec369[0];
			double fRec368 = (fTemp196 + fTemp195);
			double fTemp197 = (fConst80 * ((0.047389963799999997 * fTemp76) - ((((0.0017624207 * fTemp78) + (0.044801337500000003 * fTemp79)) + (0.0080901445999999998 * fTemp80)) + (0.1027187312 * fTemp77))));
			double fTemp198 = (fConst81 * fRec370[1]);
			double fTemp199 = (fConst82 * fRec373[1]);
			...
			fVec4[(IOTA & 63)] = (((0.1002593378 * fTemp91) + ((0.084302004700000002 * fTemp7) + ((0.024258073099999999 * fTemp89) + ((0.0017576044 * fTemp88) + ((3.2611799999999998e-05 * fTemp8) + ((0.044630025900000002 * fTemp87) + ((0.0076990019999999999 * fTemp86) + ((0.059264158400000003 * fTemp9) + (((0.076146249099999994 * fTemp11) + (fRec314 + (fRec332 + (fRec347 + (fRec359 + (fRec368 + fRec371)))))) + (0.038623926400000001 * fTemp85)))))))))) - (((0.039819054299999997 * fTemp84) + (0.012986955999999999 * fTemp10)) + (0.0062491478000000003 * fTemp90)));
			output4[i] = FAUSTFLOAT((0.96860189573459721 * (fRec0[0] * fVec4[((IOTA - iConst83) & 63)])));
			double fTemp200 = (fConst165 * fRec376[1]);
			double fTemp201 = (fConst166 * fRec379[1]);
			double fTemp202 = (fConst168 * fRec382[1]);
			double fTemp203 = (fConst169 * fRec385[1]);
			double fTemp204 = (fConst171 * ((((0.0940144958 * fTemp21) + ((0.027770521400000001 * fTemp27) + ((0.00039459709999999998 * fTemp20) + (((0.0200071112 * fTemp24) + ((0.021358784799999999 * fTemp23) + (0.099017006000000005 * fTemp19))) + (0.024264136400000001 * fTemp26))))) + (0.075777949499999997 * fTemp28)) - (((((0.10923264539999999 * fTemp16) + (0.027292551500000001 * fTemp17)) + (0.022898318000000001 * fTemp18)) + (0.050992148500000001 * fTemp25)) + (0.033099740699999998 * fTemp22))));
			double fTemp205 = (fConst172 * fRec388[1]);
			double fTemp206 = (fConst173 * fRec391[1]);
			...
			double fTemp207 = (fConst175 * fRec394[1]);
			double fTemp208 = (fConst177 * fRec397[1]);
			double fTemp209 = (fConst178 * fRec400[1]);
			double fTemp210 = (fConst180 * (((0.046007309699999999 * fTemp43) + ((((0.1054494482 * fTemp35) + (0.066178952900000004 * fTemp41)) + (0.045192961099999998 * fTemp36)) + (0.042432496600000001 * fTemp40))) - ((((0.046785333999999998 * fTemp37) + (0.025059288900000001 * fTemp42)) + (0.058512829299999999 * fTemp38)) + (0.065326148799999997 * fTemp39))));
			double fTemp211 = (fConst181 * fRec403[1]);
			double fTemp212 = (fConst182 * fRec406[1]);
			...
			double fTemp213 = (fConst184 * fRec409[1]);
			double fTemp214 = (fConst185 * fRec412[1]);
			double fTemp215 = (fConst187 * (((0.0271243215 * fTemp54) + (0.045552508399999997 * fTemp51)) - ((0.092069872900000002 * fTemp57) + ((0.032895715499999999 * fTemp53) + ((0.0004871012 * fTemp56) + ((((0.031839796500000003 * fTemp49) + (0.088706761199999998 * fTemp55)) + (0.026426747300000001 * fTemp50)) + (0.0320497145 * fTemp52)))))));
			double fTemp216 = (fConst188 * fRec415[1]);
			double fTemp217 = (fConst189 * fRec418[1]);
			...
			double fTemp218 = (fConst191 * fRec421[1]);
			double fTemp219 = (fConst193 * (((((0.040202487699999997 * fTemp66) + (0.030405793899999999 * fTemp63)) + (0.050998926399999998 * fTemp67)) + (0.064184633899999996 * fTemp64)) - ((0.071540708999999994 * fTemp62) + (0.047878692299999998 * fTemp65))));
			double fTemp220 = (fConst194 * fRec424[1]);
			double fTemp221 = (fConst195 * fRec427[1]);
			...
			double fTemp222 = (fConst197 * (0.0 - (((0.043498559300000003 * fTemp71) + (0.022458282900000001 * fTemp73)) + (0.056415701300000003 * fTemp72))));
			double fTemp223 = (fConst198 * fRec430[1]);
			fRec432[0] = (fTemp222 + (fRec432[1] + fTemp223));
			fRec430[0] = fRec432[0];
			double fRec431 = (fTemp223 + fTemp222);
			double fTemp224 = (fConst200 * (((((0.091107215800000002 * fTemp76) + (0.024832350600000001 * fTemp78)) + (0.030116068999999999 * fTemp80)) + (0.00075461400000000002 * fTemp77)) - (0.037329985400000001 * fTemp79)));
			double fTemp225 = (fConst201 * fRec433[1]);
			double fTemp226 = (fConst202 * fRec436[1]);
			...
			fVec5[0] = (((0.071310143300000003 * fTemp89) + ((0.064034057300000002 * fTemp88) + ((0.016796114800000001 * fTemp8) + ((0.051551425800000002 * fTemp87) + ((0.048988555500000003 * fTemp10) + ((0.0114673955 * fTemp84) + ((0.0557465953 * fTemp11) + (fRec377 + (fRec395 + (fRec410 + (fRec422 + (fRec431 + fRec434)))))))))))) - ((0.11231320440000001 * fTemp91) + ((0.058289273500000002 * fTemp7) + ((((0.093769827900000005 * fTemp85) + (0.068916074899999999 * fTemp9)) + (0.0290416774 * fTemp86)) + (0.031951330999999999 * fTemp90)))));
			output5[i] = FAUSTFLOAT((0.99644549763033174 * (fRec0[0] * fVec5[iConst203])));
			double fTemp227 = (fConst205 * fRec439[1]);
			double fTemp228 = (fConst206 * fRec442[1]);
			double fTemp229 = (fConst208 * fRec445[1]);
			double fTemp230 = (fConst209 * fRec448[1]);
			double fTemp231 = (fConst211 * ((((0.093948369599999998 * fTemp21) + ((0.027799201400000001 * fTemp27) + ((0.00035346960000000001 * fTemp20) + ((((0.1076208392 * fTemp16) + (0.027388993899999999 * fTemp17)) + (0.0229792326 * fTemp18)) + (0.024289195199999999 * fTemp26))))) + (0.076026811599999994 * fTemp28)) - (((0.050900800400000001 * fTemp25) + (((0.020613785400000001 * fTemp23) + (0.099300290900000004 * fTemp19)) + (0.0200778094 * fTemp24))) + (0.033133924500000002 * fTemp22))));
			double fTemp232 = (fConst212 * fRec451[1]);
			double fTemp233 = (fConst213 * fRec454[1]);
			...
			double fTemp234 = (fConst215 * fRec457[1]);
			double fTemp235 = (fConst217 * fRec460[1]);
			double fTemp236 = (fConst218 * fRec463[1]);
			double fTemp237 = (fConst220 * (((0.046187271299999999 * fTemp43) + ((0.046653136999999997 * fTemp37) + (0.042360495900000003 * fTemp40))) - ((((((0.1068269533 * fTemp35) + (0.065630764600000002 * fTemp41)) + (0.045109329500000003 * fTemp36)) + (0.025013803500000001 * fTemp42)) + (0.058620142600000001 * fTemp38)) + (0.065343757200000005 * fTemp39))));
			double fTemp238 = (fConst221 * fRec466[1]);
			double fTemp239 = (fConst222 * fRec469[1]);
			...
			double fTemp240 = (fConst224 * fRec472[1]);
			double fTemp241 = (fConst225 * fRec475[1]);
			double fTemp242 = (fConst227 * (((((0.030729217 * fTemp49) + (0.089118490600000003 * fTemp55)) + (0.0265201303 * fTemp50)) + (0.0454759468 * fTemp51)) - ((0.092052879200000007 * fTemp57) + ((0.0329296886 * fTemp53) + ((0.00043633240000000002 * fTemp56) + ((0.027220169499999999 * fTemp54) + (0.032082813799999998 * fTemp52)))))));
			double fTemp243 = (fConst228 * fRec478[1]);
			double fTemp244 = (fConst229 * fRec481[1]);
			...
			double fTemp245 = (fConst231 * fRec484[1]);
			double fTemp246 = (fConst233 * ((((((0.070611173099999994 * fTemp62) + (0.047790090600000001 * fTemp65)) + (0.030357164499999999 * fTemp63)) + (0.051110899699999997 * fTemp67)) + (0.064175543500000001 * fTemp64)) - (0.039968212900000001 * fTemp66)));
			double fTemp247 = (fConst234 * fRec487[1]);
			double fTemp248 = (fConst235 * fRec490[1]);
			...
			double fTemp249 = (fConst237 * ((0.043037713300000002 * fTemp71) - ((0.022417210999999999 * fTemp73) + (0.056570808 * fTemp72))));
			double fTemp250 = (fConst238 * fRec493[1]);
			fRec495[0] = (fTemp249 + (fRec495[1] + fTemp250));
			fRec493[0] = fRec495[0];
			double fRec494 = (fTemp250 + fTemp249);
			double fTemp251 = (fConst240 * (((0.030147171399999999 * fTemp80) + (0.00067596319999999998 * fTemp77)) - (((0.091830775399999995 * fTemp76) + (0.024920099500000001 * fTemp78)) + (0.037260704200000001 * fTemp79))));
			double fTemp252 = (fConst241 * fRec496[1]);
			double fTemp253 = (fConst242 * fRec499[1]);
			...
			output6[i] = FAUSTFLOAT((fRec0[0] * (((0.071342826999999998 * fTemp89) + ((0.064140223499999996 * fTemp88) + ((0.0167705787 * fTemp8) + ((0.028987934399999998 * fTemp86) + ((0.068517087599999998 * fTemp9) + (((0.055649018000000001 * fTemp11) + (fRec440 + (fRec458 + (fRec473 + (fRec485 + (fRec494 + fRec497)))))) + (0.094781487100000006 * fTemp85))))))) - ((0.1120615152 * fTemp91) + ((0.058439139100000002 * fTemp7) + ((((0.0131172784 * fTemp84) + (0.048897900000000001 * fTemp10)) + (0.051479534399999999 * fTemp87)) + (0.031897115099999998 * fTemp90)))))));
			double fTemp254 = (fConst244 * fRec502[1]);
			double fTemp255 = (fConst245 * fRec505[1]);
			double fTemp256 = (fConst247 * fRec508[1]);
			double fTemp257 = (fConst248 * fRec511[1]);
			double fTemp258 = (fConst250 * (((0.0014415863 * fTemp24) + (0.0089056407999999997 * fTemp22)) - (((0.049965153499999998 * fTemp21) + ((0.0074717893000000001 * fTemp27) + ((0.053691380499999997 * fTemp20) + ((0.0065283800000000003 * fTemp26) + ((((((0.1268732548 * fTemp16) + (0.0019665291999999999 * fTemp17)) + (0.0616771931 * fTemp23)) + (0.0016499084 * fTemp18)) + (0.0108097726 * fTemp19)) + (0.034663363599999997 * fTemp25)))))) + (0.020701017700000001 * fTemp28))));
			double fTemp259 = (fConst251 * fRec514[1]);
			double fTemp260 = (fConst252 * fRec517[1]);
			...
			double fTemp261 = (fConst254 * fRec520[1]);
			double fTemp262 = (fConst256 * fRec523[1]);
			double fTemp263 = (fConst257 * fRec526[1]);
			double fTemp264 = (fConst259 * ((((((0.055828059999999999 * fTemp35) + (0.070302567299999993 * fTemp41)) + (0.0119655777 * fTemp36)) + (0.0534062311 * fTemp37)) + (0.0083263287999999994 * fTemp40)) - ((((0.0081700935999999991 * fTemp42) + (0.0064465101000000004 * fTemp38)) + (0.035283916499999998 * fTemp39)) + (0.113838804 * fTemp43))));
			double fTemp265 = (fConst260 * fRec529[1]);
			double fTemp266 = (fConst261 * fRec532[1]);
			...
			double fTemp267 = (fConst263 * fRec535[1]);
			double fTemp268 = (fConst264 * fRec538[1]);
			double fTemp269 = (fConst266 * (((0.083917902500000002 * fTemp57) + ((0.0088507468999999995 * fTemp53) + ((0.066278079000000004 * fTemp56) + ((0.0086231263000000006 * fTemp52) + ((((0.091942930899999997 * fTemp49) + (0.0019544075999999998 * fTemp54)) + (0.022219500600000001 * fTemp55)) + (0.031371231200000002 * fTemp51)))))) - (0.0019041448 * fTemp50)));
			double fTemp270 = (fConst267 * fRec541[1]);
			double fTemp271 = (fConst268 * fRec544[1]);
			...
			double fTemp272 = (fConst270 * fRec547[1]);
			double fTemp273 = (fConst272 * ((((0.0027135582000000001 * fTemp63) + (0.0143464479 * fTemp67)) + (0.0626479692 * fTemp64)) - (((0.10423306290000001 * fTemp62) + (0.012676669099999999 * fTemp65)) + (0.068921481100000001 * fTemp66))));
			double fTemp274 = (fConst273 * fRec550[1]);
			double fTemp275 = (fConst274 * fRec553[1]);
			...
			double fTemp276 = (fConst276 * ((0.1141444284 * fTemp71) - ((0.0076597104000000003 * fTemp73) + (0.030655858800000001 * fTemp72))));
			double fTemp277 = (fConst277 * fRec556[1]);
			fRec558[0] = (fTemp276 + (fRec558[1] + fTemp277));
			fRec556[0] = fRec558[0];
			double fRec557 = (fTemp277 + fTemp276);
			double fTemp278 = (fConst279 * ((0.0017892626 * fTemp78) - ((((0.046685410300000001 * fTemp76) + (0.044825254000000002 * fTemp79)) + (0.0081028699000000003 * fTemp80)) + (0.1026775585 * fTemp77))));
			double fTemp279 = (fConst280 * fRec559[1]);
			double fTemp280 = (fConst281 * fRec562[1]);
			...
			fVec6[(IOTA & 127)] = (((0.10020910800000001 * fTemp91) + ((0.084371965100000001 * fTemp7) + ((0.024242776300000001 * fTemp89) + ((0.0017193669 * fTemp88) + ((4.2994999999999997e-05 * fTemp8) + ((0.012970523499999999 * fTemp10) + ((0.040804942199999999 * fTemp84) + ((0.076180743300000006 * fTemp11) + (fRec503 + (fRec521 + (fRec536 + (fRec548 + (fRec557 + fRec560))))))))))))) - (((((0.039408352399999999 * fTemp85) + (0.058807439199999999 * fTemp9)) + (0.0076892604 * fTemp86)) + (0.044768368199999999 * fTemp87)) + (0.0062696590999999999 * fTemp90)));
			output7[i] = FAUSTFLOAT((0.96623222748815174 * (fRec0[0] * fVec6[((IOTA - iConst282) & 127)])));
			double fTemp281 = (fConst284 * fRec565[1]);
			double fTemp282 = (fConst285 * fRec568[1]);
			double fTemp283 = (fConst287 * fRec571[1]);
			double fTemp284 = (fConst288 * fRec574[1]);
			double fTemp285 = (fConst290 * (((0.091987608100000007 * fTemp28) + ((0.0185516048 * fTemp22) + ((((((0.00062560770000000005 * fTemp16) + (0.013694733400000001 * fTemp17)) + (0.069419723399999994 * fTemp23)) + (0.0114898147 * fTemp18)) + (0.0780030315 * fTemp19)) + (0.0540416778 * fTemp21)))) - ((0.015564706100000001 * fTemp27) + ((0.035643449100000002 * fTemp20) + ((0.013599462099999999 * fTemp26) + ((0.010039078 * fTemp24) + (0.055265941999999998 * fTemp25)))))));
			double fTemp286 = (fConst291 * fRec577[1]);
			double fTemp287 = (fConst292 * fRec580[1]);
			...
			double fTemp288 = (fConst294 * fRec583[1]);
			double fTemp289 = (fConst296 * fRec586[1]);
			double fTemp290 = (fConst297 * fRec589[1]);
			double fTemp291 = (fConst299 * (((0.053523591400000001 * fTemp43) + ((0.038281797999999999 * fTemp40) + (((((0.0017623807 * fTemp41) + (0.0252183055 * fTemp36)) + (0.058783862399999998 * fTemp37)) + (0.038296840200000001 * fTemp38)) + (0.088788849500000003 * fTemp39)))) - ((0.078537673899999993 * fTemp35) + (0.024072916100000001 * fTemp42))));
			double fTemp292 = (fConst300 * fRec592[1]);
			double fTemp293 = (fConst301 * fRec595[1]);
			...
			double fTemp294 = (fConst303 * fRec598[1]);
			double fTemp295 = (fConst304 * fRec601[1]);
			double fTemp296 = (fConst306 * (((0.018437253599999998 * fTemp53) + ((0.043999228799999998 * fTemp56) + ((0.017963090399999999 * fTemp52) + ((0.0132602941 * fTemp50) + (0.048987982399999998 * fTemp51))))) - ((((0.1034848137 * fTemp49) + (0.0136103197 * fTemp54)) + (0.077583016399999996 * fTemp55)) + (0.037184914200000002 * fTemp57))));
			double fTemp297 = (fConst307 * fRec604[1]);
			double fTemp298 = (fConst308 * fRec607[1]);
			...
			double fTemp299 = (fConst310 * fRec610[1]);
			double fTemp300 = (fConst312 * ((0.025966635299999999 * fTemp63) - (((((0.0169713243 * fTemp62) + (0.026716981099999999 * fTemp65)) + (0.064834265299999999 * fTemp66)) + (0.035542970399999999 * fTemp67)) + (0.1148553059 * fTemp64))));
			double fTemp301 = (fConst313 * fRec613[1]);
			double fTemp302 = (fConst314 * fRec616[1]);
			...
			double fTemp303 = (fConst316 * (((0.094758667599999999 * fTemp71) + (0.042984134100000002 * fTemp72)) - (0.021726337599999999 * fTemp73)));
			double fTemp304 = (fConst317 * fRec619[1]);
			fRec621[0] = (fTemp303 + (fRec621[1] + fTemp304));
			fRec619[0] = fRec621[0];
			double fRec620 = (fTemp304 + fTemp303);
			double fTemp305 = (fConst319 * ((0.094345720399999999 * fTemp76) - ((((0.0124602649 * fTemp78) + (0.047618329600000002 * fTemp79)) + (0.016879328900000001 * fTemp80)) + (0.068163312200000006 * fTemp77))));
			double fTemp306 = (fConst320 * fRec622[1]);
			double fTemp307 = (fConst321 * fRec625[1]);
			...
			fVec7[(IOTA & 63)] = (((0.0353960106 * fTemp91) + ((0.013688239600000001 * fTemp8) + ((0.0058501385999999997 * fTemp9) + ((0.064400099399999994 * fTemp85) + ((0.027336300399999999 * fTemp10) + ((0.0910274004 * fTemp84) + ((0.073778673500000003 * fTemp11) + (fRec566 + (fRec584 + (fRec599 + (fRec611 + (fRec620 + fRec623)))))))))))) - ((0.0210231081 * fTemp7) + ((0.0288258882 * fTemp90) + ((0.082833848799999998 * fTemp89) + (((0.016205662900000001 * fTemp86) + (0.0560172964 * fTemp87)) + (0.040587609300000001 * fTemp88))))));
			...
			double fTemp312 = (fConst330 * (((0.057194619299999999 * fTemp27) + ((0.0098565402999999992 * fTemp20) + ((0.049973063999999998 * fTemp26) + ((0.045165376200000003 * fTemp24) + (0.049957004499999999 * fTemp25))))) - ((0.010768814999999999 * fTemp28) + ((0.068170382599999996 * fTemp22) + ((((((0.073362498299999995 * fTemp16) + (0.061612011100000003 * fTemp17)) + (0.0036055405000000001 * fTemp23)) + (0.0516921776 * fTemp18)) + (0.054041899800000001 * fTemp19)) + (0.020487626200000001 * fTemp21))))));
			...
			double fTemp318 = (fConst339 * (((0.0001337899 * fTemp41) + (0.050278125100000001 * fTemp42)) - ((0.048604343600000002 * fTemp43) + ((0.095734329800000004 * fTemp40) + (((((0.054495411000000001 * fTemp35) + (0.081946096999999996 * fTemp36)) + (0.029907289 * fTemp37)) + (0.035981147300000002 * fTemp38)) + (0.0145905319 * fTemp39))))));
			...
			double fTemp323 = (fConst346 * ((((0.0053748223999999997 * fTemp49) + (0.061232237699999997 * fTemp54)) + (0.0059261536999999998 * fTemp55)) - ((0.077931811099999998 * fTemp57) + ((0.0677501836 * fTemp53) + ((0.012167177499999999 * fTemp56) + (((0.0596574874 * fTemp50) + (0.038437466400000002 * fTemp51)) + (0.066007807000000002 * fTemp52)))))));
			...
			double fTemp327 = (fConst352 * (((0.064163649000000003 * fTemp62) + (0.086815996699999995 * fTemp65)) - ((((0.0050094203999999998 * fTemp66) + (0.074859751599999996 * fTemp63)) + (0.0018866346999999999 * fTemp67)) + (0.049158624499999998 * fTemp64))));
			...
			double fTemp330 = (fConst356 * (((0.058187351300000002 * fTemp71) + (0.044409850000000001 * fTemp73)) + (0.058410924599999997 * fTemp72)));
			double fTemp331 = (fConst357 * fRec682[1]);
			fRec684[0] = (fTemp330 + (fRec684[1] + fTemp331));
			fRec682[0] = fRec684[0];
			double fRec683 = (fTemp331 + fTemp330);
			double fTemp332 = (fConst359 * (((((0.074802971800000007 * fTemp76) + (0.056058190899999999 * fTemp78)) + (0.0620253786 * fTemp80)) + (0.018849310300000002 * fTemp77)) - (0.016164783799999999 * fTemp79)));
			...
			fVec8[(IOTA & 255)] = (((0.047980542899999999 * fTemp91) + ((0.072087185799999995 * fTemp90) + ((0.048316131999999998 * fTemp89) + ((0.059700930100000001 * fTemp88) + ((0.051726716300000003 * fTemp87) + (((0.056222476100000002 * fTemp11) + (fRec629 + (fRec647 + (fRec662 + (fRec674 + (fRec683 + fRec686)))))) + (0.052659796000000002 * fTemp86))))))) - ((((((0.077343672299999999 * fTemp84) + (0.088828455200000003 * fTemp10)) + (0.013629007800000001 * fTemp85)) + (0.032943674300000003 * fTemp9)) + (0.044154193100000003 * fTemp8)) + (0.022995221100000001 * fTemp7)));
			output9[i] = FAUSTFLOAT((0.89454976303317535 * (fRec0[0] * fVec8[((IOTA - iConst362) & 255)])));
			double fTemp335 = (fConst324 * fRec691[1]);
			double fTemp336 = (fConst325 * fRec694[1]);
			double fTemp337 = (fConst327 * fRec697[1]);
			double fTemp338 = (fConst328 * fRec700[1]);
			double fTemp339 = (fConst330 * (((0.057742128900000002 * fTemp27) + ((0.0089676342999999992 * fTemp20) + ((0.050451443499999998 * fTemp26) + ((((((0.070447689600000002 * fTemp16) + (0.062490335700000003 * fTemp17)) + (0.0028321221999999999 * fTemp23)) + (0.052429087700000002 * fTemp18)) + (0.055547896200000002 * fTemp19)) + (0.051593298699999998 * fTemp25))))) - ((0.0062802554000000003 * fTemp28) + ((0.0688229603 * fTemp22) + ((0.045809241899999999 * fTemp24) + (0.0222175542 * fTemp21))))));
			double fTemp340 = (fConst331 * fRec703[1]);
			double fTemp341 = (fConst332 * fRec706[1]);
			fRec708[0] = (fTemp339 + (fTemp340 + (fRec708[1] + fTemp341)));
			fRec706[0] = fRec708[0];
			double fRec707 = ((fTemp341 + fTemp340) + fTemp339);
			fRec705[0] = (fRec706[0] + fRec705[1]);
			fRec703[0] = fRec705[0];
			double fRec704 = fRec707;
			fRec702[0] = (fTemp337 + (fTemp338 + (fRec704 + fRec702[1])));
			fRec700[0] = fRec702[0];
			double fRec701 = (fTemp337 + (fRec704 + fTemp338));
			fRec699[0] = (fRec700[0] + fRec699[1]);
			fRec697[0] = fRec699[0];
			double fRec698 = fRec701;
			fRec696[0] = (fTemp335 + (fTemp336 + (fRec698 + fRec696[1])));
			fRec694[0] = fRec696[0];
			double fRec695 = (fTemp335 + (fRec698 + fTemp336));
			fRec693[0] = (fRec694[0] + fRec693[1]);
			fRec691[0] = fRec693[0];
			double fRec692 = fRec695;
			double fTemp342 = (fConst334 * fRec709[1]);
			double fTemp343 = (fConst336 * fRec712[1]);
			double fTemp344 = (fConst337 * fRec715[1]);
			double fTemp345 = (fConst339 * (((((0.054138354100000001 * fTemp35) + (0.082866157300000007 * fTemp36)) + (0.030781157399999998 * fTemp37)) + (0.051102596399999999 * fTemp42)) - ((0.045020855499999998 * fTemp43) + ((0.097064458500000006 * fTemp40) + (((0.0016183206999999999 * fTemp41) + (0.037888661099999998 * fTemp38)) + (0.0149310807 * fTemp39))))));
			double fTemp346 = (fConst340 * fRec718[1]);
			double fTemp347 = (fConst341 * fRec721[1]);
			fRec723[0] = (fTemp345 + (fTemp346 + (fRec723[1] + fTemp347)));
			fRec721[0] = fRec723[0];
			double fRec722 = ((fTemp347 + fTemp346) + fTemp345);
			fRec720[0] = (fRec721[0] + fRec720[1]);
			fRec718[0] = fRec720[0];
			double fRec719 = fRec722;
			fRec717[0] = (fTemp343 + (fTemp344 + (fRec719 + fRec717[1])));
			fRec715[0] = fRec717[0];
			double fRec716 = (fTemp343 + (fRec719 + fTemp344));
			fRec714[0] = (fRec715[0] + fRec714[1]);
			fRec712[0] = fRec714[0];
			double fRec713 = fRec716;
			fRec711[0] = (fTemp342 + (fRec713 + fRec711[1]));
			fRec709[0] = fRec711[0];
			double fRec710 = (fRec713 + fTemp342);
			double fTemp348 = (fConst343 * fRec724[1]);
			double fTemp349 = (fConst344 * fRec727[1]);
			double fTemp350 = (fConst346 * ((0.060507948899999997 * fTemp50) - ((0.076860105400000003 * fTemp57) + ((0.068398738900000006 * fTemp53) + ((0.0110698881 * fTemp56) + (((((0.0042218786000000003 * fTemp49) + (0.062105148300000003 * fTemp54)) + (0.0071027290000000003 * fTemp55)) + (0.0398251471 * fTemp51)) + (0.066639683000000005 * fTemp52)))))));
			double fTemp351 = (fConst347 * fRec730[1]);
			double fTemp352 = (fConst348 * fRec733[1]);
			fRec735[0] = (fTemp350 + (fTemp351 + (fRec735[1] + fTemp352)));
			fRec733[0] = fRec735[0];
			double fRec734 = ((fTemp352 + fTemp351) + fTemp350);
			fRec732[0] = (fRec733[0] + fRec732[1]);
			fRec730[0] = fRec732[0];
			double fRec731 = fRec734;
			fRec729[0] = (fTemp348 + (fTemp349 + (fRec731 + fRec729[1])));
			fRec727[0] = fRec729[0];
			double fRec728 = (fTemp348 + (fRec731 + fTemp349));
			fRec726[0] = (fRec727[0] + fRec726[1]);
			fRec724[0] = fRec726[0];
			double fRec725 = fRec728;
			double fTemp353 = (fConst350 * fRec736[1]);
			double fTemp354 = (fConst352 * (((0.0045147629999999998 * fTemp66) + (7.2456500000000007e-05 * fTemp67)) - ((((0.062836833100000003 * fTemp62) + (0.087790734499999995 * fTemp65)) + (0.075773940600000006 * fTemp63)) + (0.049325509500000003 * fTemp64))));
			double fTemp355 = (fConst353 * fRec739[1]);
			double fTemp356 = (fConst354 * fRec742[1]);
			fRec744[0] = (fTemp354 + (fTemp355 + (fRec744[1] + fTemp356)));
			fRec742[0] = fRec744[0];
			double fRec743 = ((fTemp356 + fTemp355) + fTemp354);
			fRec741[0] = (fRec742[0] + fRec741[1]);
			fRec739[0] = fRec741[0];
			double fRec740 = fRec743;
			fRec738[0] = (fTemp353 + (fRec740 + fRec738[1]));
			fRec736[0] = fRec738[0];
			double fRec737 = (fRec740 + fTemp353);
			double fTemp357 = (fConst356 * (((0.045152787799999997 * fTemp73) + (0.055741402799999999 * fTemp72)) - (0.058092465699999998 * fTemp71)));
			double fTemp358 = (fConst357 * fRec745[1]);
			fRec747[0] = (fTemp357 + (fRec747[1] + fTemp358));
			fRec745[0] = fRec747[0];
			double fRec746 = (fTemp358 + fTemp357);
			double fTemp359 = (fConst359 * (((0.062619131800000005 * fTemp80) + (0.017149396800000001 * fTemp77)) - (((0.073923167299999995 * fTemp76) + (0.056857341700000001 * fTemp78)) + (0.014957412200000001 * fTemp79))));
			double fTemp360 = (fConst360 * fRec748[1]);
			double fTemp361 = (fConst361 * fRec751[1]);
			...
			fVec9[(IOTA & 255)] = (((0.051666008300000003 * fTemp91) + ((0.073088762099999996 * fTemp90) + ((0.048943687600000001 * fTemp89) + ((0.061607161700000003 * fTemp88) + ((0.034631410100000003 * fTemp9) + ((0.014590972900000001 * fTemp85) + ((0.089825788099999998 * fTemp10) + ((0.0719422641 * fTemp84) + ((0.054517427600000001 * fTemp11) + (fRec692 + (fRec710 + (fRec725 + (fRec737 + (fRec746 + fRec749)))))))))))))) - (((0.044641760400000001 * fTemp8) + ((0.053251040600000001 * fTemp86) + (0.052846259899999998 * fTemp87))) + (0.0259563755 * fTemp7)));
			output10[i] = FAUSTFLOAT((0.89454976303317535 * (fRec0[0] * fVec9[((IOTA - iConst362) & 255)])));
			double fTemp362 = (fConst364 * fRec754[1]);
			double fTemp363 = (fConst365 * fRec757[1]);
			double fTemp364 = (fConst367 * fRec760[1]);
			double fTemp365 = (fConst368 * fRec763[1]);
			double fTemp366 = (fConst370 * ((((((0.068777297500000001 * fTemp17) + (0.057703817999999997 * fTemp18)) + (0.045610196499999998 * fTemp25)) + (0.0058274434999999996 * fTemp20)) + (0.069444035200000004 * fTemp22)) - (((0.0455325444 * fTemp21) + ((((((0.034480682999999998 * fTemp16) + (0.012275583600000001 * fTemp23)) + (0.064481375199999996 * fTemp19)) + (0.050417969799999997 * fTemp24)) + (0.050906729400000003 * fTemp26)) + (0.0582632077 * fTemp27))) + (0.0302803367 * fTemp28))));
			double fTemp367 = (fConst371 * fRec766[1]);
			double fTemp368 = (fConst372 * fRec769[1]);
			fRec771[0] = (fTemp366 + (fTemp367 + (fRec771[1] + fTemp368)));
			fRec769[0] = fRec771[0];
			double fRec770 = ((fTemp368 + fTemp367) + fTemp366);
			fRec768[0] = (fRec769[0] + fRec768[1]);
			fRec766[0] = fRec768[0];
			double fRec767 = fRec770;
			fRec765[0] = (fTemp364 + (fTemp365 + (fRec767 + fRec765[1])));
			fRec763[0] = fRec765[0];
			double fRec764 = (fTemp364 + (fRec767 + fTemp365));
			fRec762[0] = (fRec763[0] + fRec762[1]);
			fRec760[0] = fRec762[0];
			double fRec761 = fRec764;
			fRec759[0] = (fTemp362 + (fTemp363 + (fRec761 + fRec759[1])));
			fRec757[0] = fRec759[0];
			double fRec758 = (fTemp362 + (fRec761 + fTemp363));
			fRec756[0] = (fRec757[0] + fRec756[1]);
			fRec754[0] = fRec756[0];
			double fRec755 = fRec758;
			double fTemp369 = (fConst374 * fRec772[1]);
			double fTemp370 = (fConst376 * fRec775[1]);
			double fTemp371 = (fConst377 * fRec778[1]);
			double fTemp372 = (fConst379 * (((((0.026239308999999999 * fTemp38) + (((0.017684819500000001 * fTemp35) + (0.0283656729 * fTemp37)) + (0.050402315000000003 * fTemp42))) + (0.022267265200000001 * fTemp39)) + (0.050896803400000003 * fTemp43)) - (((0.017003137099999999 * fTemp41) + (0.090908184700000005 * fTemp36)) + (0.097860165400000004 * fTemp40))));
			double fTemp373 = (fConst380 * fRec781[1]);
			double fTemp374 = (fConst381 * fRec784[1]);
			fRec786[0] = (fTemp372 + (fTemp373 + (fRec786[1] + fTemp374)));
			fRec784[0] = fRec786[0];
			double fRec785 = ((fTemp374 + fTemp373) + fTemp372);
			fRec783[0] = (fRec784[0] + fRec783[1]);
			fRec781[0] = fRec783[0];
			double fRec782 = fRec785;
			fRec780[0] = (fTemp370 + (fTemp371 + (fRec782 + fRec780[1])));
			fRec778[0] = fRec780[0];
			double fRec779 = (fTemp370 + (fRec782 + fTemp371));
			fRec777[0] = (fRec778[0] + fRec777[1]);
			fRec775[0] = fRec777[0];
			double fRec776 = fRec779;
			fRec774[0] = (fTemp369 + (fRec776 + fRec774[1]));
			fRec772[0] = fRec774[0];
			double fRec773 = (fRec776 + fTemp369);
			double fTemp375 = (fConst383 * fRec787[1]);
			double fTemp376 = (fConst384 * fRec790[1]);
			double fTemp377 = (fConst386 * ((((((0.018299359599999999 * fTemp49) + (0.0121651733 * fTemp55)) + (0.066595468699999993 * fTemp50)) + (0.067241055499999994 * fTemp52)) + (0.069015985500000002 * fTemp53)) - ((((0.068353357500000003 * fTemp54) + (0.034926616299999998 * fTemp51)) + (0.0071935525000000004 * fTemp56)) + (0.043005755700000002 * fTemp57))));
			double fTemp378 = (fConst387 * fRec793[1]);
			double fTemp379 = (fConst388 * fRec796[1]);
			fRec798[0] = (fTemp377 + (fTemp378 + (fRec798[1] + fTemp379)));
			fRec796[0] = fRec798[0];
			double fRec797 = ((fTemp379 + fTemp378) + fTemp377);
			fRec795[0] = (fRec796[0] + fRec795[1]);
			fRec793[0] = fRec795[0];
			double fRec794 = fRec797;
			fRec792[0] = (fTemp375 + (fTemp376 + (fRec794 + fRec792[1])));
			fRec790[0] = fRec792[0];
			double fRec791 = (fTemp375 + (fRec794 + fTemp376));
			fRec789[0] = (fRec790[0] + fRec789[1]);
			fRec787[0] = fRec789[0];
			double fRec788 = fRec791;
			double fTemp380 = (fConst390 * fRec799[1]);
			double fTemp381 = (fConst392 * (((((0.096310684100000002 * fTemp65) + (0.011941526799999999 * fTemp66)) + (0.0150947779 * fTemp67)) + (0.038883076500000002 * fTemp64)) - ((0.046145150900000001 * fTemp62) + (0.077514319900000003 * fTemp63))));
			double fTemp382 = (fConst393 * fRec802[1]);
			double fTemp383 = (fConst394 * fRec805[1]);
			fRec807[0] = (fTemp381 + (fTemp382 + (fRec807[1] + fTemp383)));
			fRec805[0] = fRec807[0];
			double fRec806 = ((fTemp383 + fTemp382) + fTemp381);
			fRec804[0] = (fRec805[0] + fRec804[1]);
			fRec802[0] = fRec804[0];
			double fRec803 = fRec806;
			fRec801[0] = (fTemp380 + (fRec803 + fRec801[1]));
			fRec799[0] = fRec801[0];
			double fRec800 = (fRec803 + fTemp380);
			double fTemp384 = (fConst396 * ((0.044403731600000003 * fTemp73) - ((0.075323093300000005 * fTemp71) + (0.081013484400000002 * fTemp72))));
			double fTemp385 = (fConst397 * fRec808[1]);
			fRec810[0] = (fTemp384 + (fRec810[1] + fTemp385));
			fRec808[0] = fRec810[0];
			double fRec809 = (fTemp385 + fTemp384);
			double fTemp386 = (fConst399 * (((0.074322458999999994 * fTemp76) + (0.011144203599999999 * fTemp77)) - (((0.062577585099999999 * fTemp78) + (0.024658184400000002 * fTemp79)) + (0.063184221900000004 * fTemp80))));
			double fTemp387 = (fConst400 * fRec811[1]);
			double fTemp388 = (fConst401 * fRec814[1]);
			...
			fVec10[(IOTA & 255)] = (((0.022487628700000001 * fTemp7) + ((0.073687923000000002 * fTemp90) + ((0.058418968500000001 * fTemp86) + ((0.050621721299999999 * fTemp9) + ((0.044425515200000001 * fTemp85) + ((0.043384771500000002 * fTemp84) + ((0.070763039099999994 * fTemp11) + (fRec755 + (fRec773 + (fRec788 + (fRec800 + (fRec809 + fRec812)))))))))))) - (((0.055301956200000002 * fTemp89) + ((0.051923624600000003 * fTemp88) + ((0.046126926899999997 * fTemp8) + ((0.098543236500000006 * fTemp10) + (0.053455953200000003 * fTemp87))))) + (0.00055112439999999998 * fTemp91)));
			output11[i] = FAUSTFLOAT((0.90343601895734593 * (fRec0[0] * fVec10[((IOTA - iConst402) & 255)])));
			double fTemp389 = (fConst324 * fRec817[1]);
			double fTemp390 = (fConst325 * fRec820[1]);
			double fTemp391 = (fConst327 * fRec823[1]);
			double fTemp392 = (fConst328 * fRec826[1]);
			double fTemp393 = (fConst330 * (((((0.045434149299999997 * fTemp25) + ((0.050301841399999998 * fTemp24) + (((0.033764286800000001 * fTemp16) + (0.012245999699999999 * fTemp23)) + (0.064699307600000006 * fTemp19)))) + (0.0059146066000000004 * fTemp20)) + (0.069511366399999996 * fTemp22)) - (((0.045377590099999997 * fTemp21) + ((((0.068618881800000003 * fTemp17) + (0.057570907999999997 * fTemp18)) + (0.0509560872 * fTemp26)) + (0.058319698199999999 * fTemp27))) + (0.030762017799999999 * fTemp28))));
			double fTemp394 = (fConst331 * fRec829[1]);
			double fTemp395 = (fConst332 * fRec832[1]);
			fRec834[0] = (fTemp393 + (fTemp394 + (fRec834[1] + fTemp395)));
			fRec832[0] = fRec834[0];
			double fRec833 = ((fTemp395 + fTemp394) + fTemp393);
			fRec831[0] = (fRec832[0] + fRec831[1]);
			fRec829[0] = fRec831[0];
			double fRec830 = fRec833;
			fRec828[0] = (fTemp391 + (fTemp392 + (fRec830 + fRec828[1])));
			fRec826[0] = fRec828[0];
			double fRec827 = (fTemp391 + (fRec830 + fTemp392));
			fRec825[0] = (fRec826[0] + fRec825[1]);
			fRec823[0] = fRec825[0];
			double fRec824 = fRec827;
			fRec822[0] = (fTemp389 + (fTemp390 + (fRec824 + fRec822[1])));
			fRec820[0] = fRec822[0];
			double fRec821 = (fTemp389 + (fRec824 + fTemp390));
			fRec819[0] = (fRec820[0] + fRec819[1]);
			fRec817[0] = fRec819[0];
			double fRec818 = fRec821;
			double fTemp396 = (fConst334 * fRec835[1]);
			double fTemp397 = (fConst336 * fRec838[1]);
			double fTemp398 = (fConst337 * fRec841[1]);
			double fTemp399 = (fConst339 * (((((0.026445657500000001 * fTemp38) + (((0.016824718499999999 * fTemp41) + (0.091072426600000006 * fTemp36)) + (0.050314737499999998 * fTemp42))) + (0.022302516599999999 * fTemp39)) + (0.050531133700000001 * fTemp43)) - (((0.0179356949 * fTemp35) + (0.028235102299999999 * fTemp37)) + (0.097720412699999995 * fTemp40))));
			double fTemp400 = (fConst340 * fRec844[1]);
			double fTemp401 = (fConst341 * fRec847[1]);
			fRec849[0] = (fTemp399 + (fTemp400 + (fRec849[1] + fTemp401)));
			fRec847[0] = fRec849[0];
			double fRec848 = ((fTemp401 + fTemp400) + fTemp399);
			fRec846[0] = (fRec847[0] + fRec846[1]);
			fRec844[0] = fRec846[0];
			double fRec845 = fRec848;
			fRec843[0] = (fTemp397 + (fTemp398 + (fRec845 + fRec843[1])));
			fRec841[0] = fRec843[0];
			double fRec842 = (fTemp397 + (fRec845 + fTemp398));
			fRec840[0] = (fRec841[0] + fRec840[1]);
			fRec838[0] = fRec840[0];
			double fRec839 = fRec842;
			fRec837[0] = (fTemp396 + (fRec839 + fRec837[1]));
			fRec835[0] = fRec837[0];
			double fRec836 = (fRec839 + fTemp396);
			double fTemp402 = (fConst343 * fRec850[1]);
			double fTemp403 = (fConst344 * fRec853[1]);
			double fTemp404 = (fConst346 * ((((0.068195918199999997 * fTemp54) + (0.0673062507 * fTemp52)) + (0.069082901599999996 * fTemp53)) - ((((((0.018255258600000001 * fTemp49) + (0.0123123661 * fTemp55)) + (0.066442078399999993 * fTemp50)) + (0.034777961000000003 * fTemp51)) + (0.0073011489000000002 * fTemp56)) + (0.0430783993 * fTemp57))));
			double fTemp405 = (fConst347 * fRec856[1]);
			double fTemp406 = (fConst348 * fRec859[1]);
			fRec861[0] = (fTemp404 + (fTemp405 + (fRec861[1] + fTemp406)));
			fRec859[0] = fRec861[0];
			double fRec860 = ((fTemp406 + fTemp405) + fTemp404);
			fRec858[0] = (fRec859[0] + fRec858[1]);
			fRec856[0] = fRec858[0];
			double fRec857 = fRec860;
			fRec855[0] = (fTemp402 + (fTemp403 + (fRec857 + fRec855[1])));
			fRec853[0] = fRec855[0];
			double fRec854 = (fTemp402 + (fRec857 + fTemp403));
			fRec852[0] = (fRec853[0] + fRec852[1]);
			fRec850[0] = fRec852[0];
			double fRec851 = fRec854;
			double fTemp407 = (fConst350 * fRec862[1]);
			double fTemp408 = (fConst352 * ((((0.046249397900000003 * fTemp62) + (0.0148805814 * fTemp67)) + (0.038900122099999997 * fTemp64)) - (((0.096484686700000002 * fTemp65) + (0.011996538899999999 * fTemp66)) + (0.077419221600000004 * fTemp63))));
			double fTemp409 = (fConst353 * fRec865[1]);
			double fTemp410 = (fConst354 * fRec868[1]);
			fRec870[0] = (fTemp408 + (fTemp409 + (fRec870[1] + fTemp410)));
			fRec868[0] = fRec870[0];
			double fRec869 = ((fTemp410 + fTemp409) + fTemp408);
			fRec867[0] = (fRec868[0] + fRec867[1]);
			fRec865[0] = fRec867[0];
			double fRec866 = fRec869;
			fRec864[0] = (fTemp407 + (fRec866 + fRec864[1]));
			fRec862[0] = fRec864[0];
			double fRec863 = (fRec866 + fTemp407);
			double fTemp411 = (fConst356 * (((0.075284350599999994 * fTemp71) + (0.044324720499999998 * fTemp73)) - (0.080718351899999999 * fTemp72)));
			double fTemp412 = (fConst357 * fRec871[1]);
			fRec873[0] = (fTemp411 + (fRec873[1] + fTemp412));
			fRec871[0] = fRec873[0];
			double fRec872 = (fTemp412 + fTemp411);
			double fTemp413 = (fConst359 * (((0.062433449299999999 * fTemp78) + (0.011310891199999999 * fTemp77)) - (((0.074262754700000003 * fTemp76) + (0.0247910701 * fTemp79)) + (0.063245483699999994 * fTemp80))));
			double fTemp414 = (fConst360 * fRec874[1]);
			double fTemp415 = (fConst361 * fRec877[1]);
			...
			fVec11[(IOTA & 255)] = (((0.0227904006 * fTemp7) + ((0.073582690399999998 * fTemp90) + ((0.0532771218 * fTemp87) + (((0.070951386800000002 * fTemp11) + (fRec818 + (fRec836 + (fRec851 + (fRec863 + (fRec872 + fRec875)))))) + (0.098721272499999999 * fTemp10))))) - (((0.055366799799999998 * fTemp89) + ((0.052128447699999997 * fTemp88) + (((((0.044526459800000001 * fTemp84) + (0.044125769099999997 * fTemp85)) + (0.050390714000000003 * fTemp9)) + (0.058524512799999998 * fTemp86)) + (0.046076652400000001 * fTemp8)))) + (0.00099523030000000005 * fTemp91)));
			output12[i] = FAUSTFLOAT((0.89454976303317535 * (fRec0[0] * fVec11[((IOTA - iConst362) & 255)])));
			double fTemp416 = (fConst404 * fRec880[1]);
			double fTemp417 = (fConst405 * fRec883[1]);
			double fTemp418 = (fConst407 * fRec886[1]);
			double fTemp419 = (fConst408 * fRec889[1]);
			double fTemp420 = (fConst410 * (((0.0040173824 * fTemp21) + ((0.00078556510000000004 * fTemp27) + ((0.00042796240000000002 * fTemp20) + ((0.00068637739999999998 * fTemp26) + ((((4.7959000000000001e-06 * fTemp17) + (5.07806e-05 * fTemp23)) + (4.0237000000000001e-06 * fTemp18)) + (0.1352667401 * fTemp25)))))) - ((0.001735232 * fTemp28) + ((((0.00012090670000000001 * fTemp16) + (1.6668e-05 * fTemp19)) + (3.5157000000000001e-06 * fTemp24)) + (0.00093631669999999999 * fTemp22)))));
			double fTemp421 = (fConst411 * fRec892[1]);
			double fTemp422 = (fConst412 * fRec895[1]);
			fRec897[0] = (fTemp420 + (fTemp421 + (fRec897[1] + fTemp422)));
			fRec895[0] = fRec897[0];
			double fRec896 = ((fTemp422 + fTemp421) + fTemp420);
			fRec894[0] = (fRec895[0] + fRec894[1]);
			fRec892[0] = fRec894[0];
			double fRec893 = fRec896;
			fRec891[0] = (fTemp418 + (fTemp419 + (fRec893 + fRec891[1])));
			fRec889[0] = fRec891[0];
			double fRec890 = (fTemp418 + (fRec893 + fTemp419));
			fRec888[0] = (fRec889[0] + fRec888[1]);
			fRec886[0] = fRec888[0];
			double fRec887 = fRec890;
			fRec885[0] = (fTemp416 + (fTemp417 + (fRec887 + fRec885[1])));
			fRec883[0] = fRec885[0];
			double fRec884 = (fTemp416 + (fRec887 + fTemp417));
			fRec882[0] = (fRec883[0] + fRec882[1]);
			fRec880[0] = fRec882[0];
			double fRec881 = fRec884;
			double fTemp423 = (fConst414 * fRec898[1]);
			double fTemp424 = (fConst416 * fRec901[1]);
			double fTemp425 = (fConst417 * fRec904[1]);
			double fTemp426 = (fConst419 * (((0.0017852394 * fTemp43) + ((0.020015226699999999 * fTemp40) + ((((3.4615900000000002e-05 * fTemp41) + (4.1349e-06 * fTemp36)) + (0.12491262390000001 * fTemp42)) + (0.0029540611 * fTemp39)))) - (((9.9851200000000004e-05 * fTemp35) + (7.4582e-06 * fTemp37)) + (0.0025882869999999999 * fTemp38))));
			double fTemp427 = (fConst420 * fRec907[1]);
			double fTemp428 = (fConst421 * fRec910[1]);
			fRec912[0] = (fTemp426 + (fTemp427 + (fRec912[1] + fTemp428)));
			fRec910[0] = fRec912[0];
			double fRec911 = ((fTemp428 + fTemp427) + fTemp426);
			fRec909[0] = (fRec910[0] + fRec909[1]);
			fRec907[0] = fRec909[0];
			double fRec908 = fRec911;
			fRec906[0] = (fTemp424 + (fTemp425 + (fRec908 + fRec906[1])));
			fRec904[0] = fRec906[0];
			double fRec905 = (fTemp424 + (fRec908 + fTemp425));
			fRec903[0] = (fRec904[0] + fRec903[1]);
			fRec901[0] = fRec903[0];
			double fRec902 = fRec905;
			fRec900[0] = (fTemp423 + (fRec902 + fRec900[1]));
			fRec898[0] = fRec900[0];
			double fRec899 = (fRec902 + fTemp423);
			double fTemp429 = (fConst423 * fRec913[1]);
			double fTemp430 = (fConst424 * fRec916[1]);
			double fTemp431 = (fConst426 * (((((2.36426e-05 * fTemp55) + (4.6437000000000001e-06 * fTemp50)) + (0.13111606410000001 * fTemp51)) + (0.016689738900000001 * fTemp57)) - ((0.00093054520000000003 * fTemp53) + ((0.00052828830000000002 * fTemp56) + (((7.5699300000000002e-05 * fTemp49) + (4.7662999999999996e-06 * fTemp54)) + (0.00090661379999999996 * fTemp52))))));
			double fTemp432 = (fConst427 * fRec919[1]);
			double fTemp433 = (fConst428 * fRec922[1]);
			fRec924[0] = (fTemp431 + (fTemp432 + (fRec924[1] + fTemp433)));
			fRec922[0] = fRec924[0];
			double fRec923 = ((fTemp433 + fTemp432) + fTemp431);
			fRec921[0] = (fRec922[0] + fRec921[1]);
			fRec919[0] = fRec921[0];
			double fRec920 = fRec923;
			fRec918[0] = (fTemp429 + (fTemp430 + (fRec920 + fRec918[1])));
			fRec916[0] = fRec918[0];
			double fRec917 = (fTemp429 + (fRec920 + fTemp430));
			fRec915[0] = (fRec916[0] + fRec915[1]);
			fRec913[0] = fRec915[0];
			double fRec914 = fRec917;
			double fTemp434 = (fConst430 * fRec925[1]);
			double fTemp435 = (fConst432 * ((((1.27686e-05 * fTemp66) + (0.15107526560000001 * fTemp63)) + (0.0026229220000000002 * fTemp67)) - (((5.73446e-05 * fTemp62) + (4.3806e-06 * fTemp65)) + (0.0054442884000000004 * fTemp64))));
			double fTemp436 = (fConst433 * fRec928[1]);
			double fTemp437 = (fConst434 * fRec931[1]);
			fRec933[0] = (fTemp435 + (fTemp436 + (fRec933[1] + fTemp437)));
			fRec931[0] = fRec933[0];
			double fRec932 = ((fTemp437 + fTemp436) + fTemp435);
			fRec930[0] = (fRec931[0] + fRec930[1]);
			fRec928[0] = fRec930[0];
			double fRec929 = fRec932;
			fRec927[0] = (fTemp434 + (fRec929 + fRec927[1]));
			fRec925[0] = fRec927[0];
			double fRec926 = (fRec929 + fTemp434);
			double fTemp438 = (fConst436 * ((0.12613950730000001 * fTemp73) - ((2.4743500000000001e-05 * fTemp71) + (0.0035232581000000001 * fTemp72))));
			double fTemp439 = (fConst437 * fRec934[1]);
			fRec936[0] = (fTemp438 + (fRec936[1] + fTemp439));
			fRec934[0] = fRec936[0];
			double fRec935 = (fTemp439 + fTemp438);
			double fTemp440 = (fConst439 * ((((0.15526304469999999 * fTemp79) + (0.00085191529999999996 * fTemp80)) + (0.00081842069999999995 * fTemp77)) - ((4.0864600000000002e-05 * fTemp76) + (4.3636e-06 * fTemp78))));
			double fTemp441 = (fConst440 * fRec937[1]);
			double fTemp442 = (fConst441 * fRec940[1]);
			fRec942[0] = (fTemp440 + (fTemp441 + (fRec942[1] + fTemp442)));
			fRec940[0] = fRec942[0];
			double fRec941 = ((fTemp442 + fTemp441) + fTemp440);
			fRec939[0] = (fRec940[0] + fRec939[1]);
			fRec937[0] = fRec939[0];
			double fRec938 = fRec941;
			fVec12[(IOTA & 1023)] = (((0.0026081569999999998 * fTemp88) + ((0.14465563840000001 * fTemp8) + ((4.3301999999999996e-06 * fTemp87) + ((7.15323e-05 * fTemp85) + (((0.090751501499999998 * fTemp11) + (fRec881 + (fRec899 + (fRec914 + (fRec926 + (fRec935 + fRec938)))))) + (4.4822e-06 * fTemp10)))))) - ((0.0056077784 * fTemp91) + ((0.0019764035 * fTemp7) + ((0.0150713059 * fTemp90) + ((((0.00012654459999999999 * fTemp84) + (2.5884099999999998e-05 * fTemp9)) + (2.6570999999999999e-06 * fTemp86)) + (0.0019280349 * fTemp89))))));
